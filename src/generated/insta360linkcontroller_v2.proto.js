 ...
 * @exports ParamType
 * @enum {number}
 * @property {number} PARAM_MIRROR_VER=1 PARAM_MIRROR_VER value
 * @property {number} PARAM_MIRROR_HOR=2 PARAM_MIRROR_HOR value
 * @property {number} PARAM_RESET_PTZ=3 PARAM_RESET_PTZ value
 * @property {number} PARAM_ZOOM=4 PARAM_ZOOM value
 * @property {number} PARAM_VIDEO_MODE=5 PARAM_VIDEO_MODE value
 * @property {number} PARAM_PTZ_MID=6 PARAM_PTZ_MID value
 * @property {number} PARAM_PTZ_OP=7 PARAM_PTZ_OP value
 * @property {number} PATAM_PTZ_HOST=8 PATAM_PTZ_HOST value
 * @property {number} PARAM_TRACK_SPEED=9 PARAM_TRACK_SPEED value
 * @property {number} PARAM_COMPOSITION_STYLE=10 PARAM_COMPOSITION_STYLE value
 * @property {number} PARAM_COMPOSITION_STYLE_SWITCH=11 PARAM_COMPOSITION_STYLE_SWITCH value
 * @property {number} PARAM_AUTO_TRACK=12 PARAM_AUTO_TRACK value
 * @property {number} PARAM_SINGLE_TAPTRACKING=13 PARAM_SINGLE_TAPTRACKING value
 * @property {number} PARAM_ISO_VALUE=14 PARAM_ISO_VALUE value
 * @property {number} PARAM_SHUTTER_VALUE=15 PARAM_SHUTTER_VALUE value
 * @property {number} PARAM_EXPOSURE_COMPENSATION=16 PARAM_EXPOSURE_COMPENSATION value
 * @property {number} PARAM_AUTO_EXPOSURE=17 PARAM_AUTO_EXPOSURE value
 * @property {number} PARAM_AUTO_FOCUS=18 PARAM_AUTO_FOCUS value
 * @property {number} PARAM_MANUAL_FOCUS_VALUE=19 PARAM_MANUAL_FOCUS_VALUE value
 * @property {number} PARAM_AUTO_WHITEBALANCE=20 PARAM_AUTO_WHITEBALANCE value
 * @property {number} PARAM_WHITE_BALANCE_TEMP=21 PARAM_WHITE_BALANCE_TEMP value
 * @property {number} PARAM_BRIGHTNESS=22 PARAM_BRIGHTNESS value
 * @property {number} PARAM_CONTRAST=23 PARAM_CONTRAST value
 * @property {number} PARAM_SATURATION=24 PARAM_SATURATION value
 * @property {number} PARAM_SHARPNESS=25 PARAM_SHARPNESS value
 * @property {number} PARAM_HDR=26 PARAM_HDR value
 * @property {number} PARAM_AUTI_FLICK=27 PARAM_AUTI_FLICK value
 * @property {number} PARAM_BLUR_SWITCH=28 PARAM_BLUR_SWITCH value
 * @property {number} PARAM_REPLACE_SWITCH=29 PARAM_REPLACE_SWITCH value
 * @property {number} PARAM_BLUR_RADIUS=30 PARAM_BLUR_RADIUS value
 * @property {number} PARAM_BLUR_MODE=31 PARAM_BLUR_MODE value
 * @property {number} PARAM_REPLACE_INDEX=32 PARAM_REPLACE_INDEX value
 * @property {number} PARAM_AUDIO_CAPTURE_MODE=33 PARAM_AUDIO_CAPTURE_MODE value
 * @property {number} PARAM_SMART_ADJUST=34 PARAM_SMART_ADJUST value
 * @property {number} PARAM_PRIVACY_MODE=35 PARAM_PRIVACY_MODE value
 * @property {number} PARAM_ROLL_ADJUST=36 PARAM_ROLL_ADJUST value
 * @property {number} PARAM_LOWER_RES=37 PARAM_LOWER_RES value
 * @property {number} PARAM_VERTICAL_SCREEN=38 PARAM_VERTICAL_SCREEN value
 * @property {number} PARAM_GESTURE_TOTAL_SWITCH=39 PARAM_GESTURE_TOTAL_SWITCH value
 * @property {number} PARAM_GESTURE_PALM_SWITCH=40 PARAM_GESTURE_PALM_SWITCH value
 * @property {number} PARAM_GESTURE_V_SWITCH=41 PARAM_GESTURE_V_SWITCH value
 * @property {number} PARAM_GESTURE_L_SWITCH=42 PARAM_GESTURE_L_SWITCH value
 * @property {number} PARAM_GESTURE_ROCK_SWITCH=43 PARAM_GESTURE_ROCK_SWITCH value
 * @property {number} PARAM_GESTURE_OK_SWITCH=44 PARAM_GESTURE_OK_SWITCH value
 * @property {number} PARAM_HOST_PTZ_INFO=45 PARAM_HOST_PTZ_INFO value
 * @property {number} PARAM_IMAGE_FILTER=46 PARAM_IMAGE_FILTER value
 * @property {number} PARAM_IMAGE_TEMPLATE=47 PARAM_IMAGE_TEMPLATE value
 * @property {number} PARAM_CLOSE_BLUR_REPLACE=48 PARAM_CLOSE_BLUR_REPLACE value
 * @property {number} PARAM_VIDEO_PRIVACY_MODE=49 PARAM_VIDEO_PRIVACY_MODE value
 * @property {number} PARAM_FINE_TUNING=50 PARAM_FINE_TUNING value
 * @property {number} PARAM_TRACK_FIRBOIDDEN_AREA=51 PARAM_TRACK_FIRBOIDDEN_AREA value
 * @property {number} PARAM_VER_SCREEN_LOCK=52 PARAM_VER_SCREEN_LOCK value
 * @property {number} PARAM_ROLL=100 PARAM_ROLL value
 * @property {number} PARAM_PAN_TILT_ABSOLUTE=101 PARAM_PAN_TILT_ABSOLUTE value
 * @property {number} PARAM_PAN_TILT_RELATIVE=102 PARAM_PAN_TILT_RELATIVE value
 * @property {number} PARAM_PRESET_POSITION=103 PARAM_PRESET_POSITION value
 * @property {number} PARAM_BIAS=104 PARAM_BIAS value
 * @property {number} PARAM_CHANGE_DEVICE_NAME=105 PARAM_CHANGE_DEVICE_NAME value
 * @property {number} PARAM_RESOLUTION=106 PARAM_RESOLUTION value
 * @property {number} PARAM_IMAGEPARAM_RESET=107 PARAM_IMAGEPARAM_RESET value
 * @property {number} PARAM_SAVE_IMAGEPARAM_PRESET=108 PARAM_SAVE_IMAGEPARAM_PRESET value
 */
export const ParamType = $root.ParamType = (() => {
    const valuesById = {}, values = Object.create(valuesById);
    values[valuesById[1] = "PARAM_MIRROR_VER"] = 1;
    values[valuesById[2] = "PARAM_MIRROR_HOR"] = 2;
    values[valuesById[3] = "PARAM_RESET_PTZ"] = 3;
    values[valuesById[4] = "PARAM_ZOOM"] = 4;
    values[valuesById[5] = "PARAM_VIDEO_MODE"] = 5;
    values[valuesById[6] = "PARAM_PTZ_MID"] = 6;
    values[valuesById[7] = "PARAM_PTZ_OP"] = 7;
    values[valuesById[8] = "PATAM_PTZ_HOST"] = 8;
    values[valuesById[9] = "PARAM_TRACK_SPEED"] = 9;
    values[valuesById[10] = "PARAM_COMPOSITION_STYLE"] = 10;
    values[valuesById[11] = "PARAM_COMPOSITION_STYLE_SWITCH"] = 11;
    values[valuesById[12] = "PARAM_AUTO_TRACK"] = 12;
    values[valuesById[13] = "PARAM_SINGLE_TAPTRACKING"] = 13;
    values[valuesById[14] = "PARAM_ISO_VALUE"] = 14;
    values[valuesById[15] = "PARAM_SHUTTER_VALUE"] = 15;
    values[valuesById[16] = "PARAM_EXPOSURE_COMPENSATION"] = 16;
    values[valuesById[17] = "PARAM_AUTO_EXPOSURE"] = 17;
    values[valuesById[18] = "PARAM_AUTO_FOCUS"] = 18;
    values[valuesById[19] = "PARAM_MANUAL_FOCUS_VALUE"] = 19;
    values[valuesById[20] = "PARAM_AUTO_WHITEBALANCE"] = 20;
    values[valuesById[21] = "PARAM_WHITE_BALANCE_TEMP"] = 21;
    values[valuesById[22] = "PARAM_BRIGHTNESS"] = 22;
    values[valuesById[23] = "PARAM_CONTRAST"] = 23;
    values[valuesById[24] = "PARAM_SATURATION"] = 24;
    values[valuesById[25] = "PARAM_SHARPNESS"] = 25;
    values[valuesById[26] = "PARAM_HDR"] = 26;
    values[valuesById[27] = "PARAM_AUTI_FLICK"] = 27;
    values[valuesById[28] = "PARAM_BLUR_SWITCH"] = 28;
    values[valuesById[29] = "PARAM_REPLACE_SWITCH"] = 29;
    values[valuesById[30] = "PARAM_BLUR_RADIUS"] = 30;
    values[valuesById[31] = "PARAM_BLUR_MODE"] = 31;
    values[valuesById[32] = "PARAM_REPLACE_INDEX"] = 32;
    values[valuesById[33] = "PARAM_AUDIO_CAPTURE_MODE"] = 33;
    values[valuesById[34] = "PARAM_SMART_ADJUST"] = 34;
    values[valuesById[35] = "PARAM_PRIVACY_MODE"] = 35;
    values[valuesById[36] = "PARAM_ROLL_ADJUST"] = 36;
    values[valuesById[37] = "PARAM_LOWER_RES"] = 37;
    values[valuesById[38] = "PARAM_VERTICAL_SCREEN"] = 38;
    values[valuesById[39] = "PARAM_GESTURE_TOTAL_SWITCH"] = 39;
    values[valuesById[40] = "PARAM_GESTURE_PALM_SWITCH"] = 40;
    values[valuesById[41] = "PARAM_GESTURE_V_SWITCH"] = 41;
    values[valuesById[42] = "PARAM_GESTURE_L_SWITCH"] = 42;
    values[valuesById[43] = "PARAM_GESTURE_ROCK_SWITCH"] = 43;
    values[valuesById[44] = "PARAM_GESTURE_OK_SWITCH"] = 44;
    values[valuesById[45] = "PARAM_HOST_PTZ_INFO"] = 45;
    values[valuesById[46] = "PARAM_IMAGE_FILTER"] = 46;
    values[valuesById[47] = "PARAM_IMAGE_TEMPLATE"] = 47;
    values[valuesById[48] = "PARAM_CLOSE_BLUR_REPLACE"] = 48;
    values[valuesById[49] = "PARAM_VIDEO_PRIVACY_MODE"] = 49;
    values[valuesById[50] = "PARAM_FINE_TUNING"] = 50;
    values[valuesById[51] = "PARAM_TRACK_FIRBOIDDEN_AREA"] = 51;
    values[valuesById[52] = "PARAM_VER_SCREEN_LOCK"] = 52;
    values[valuesById[100] = "PARAM_ROLL"] = 100;
    values[valuesById[101] = "PARAM_PAN_TILT_ABSOLUTE"] = 101;
    values[valuesById[102] = "PARAM_PAN_TILT_RELATIVE"] = 102;
    values[valuesById[103] = "PARAM_PRESET_POSITION"] = 103;
    values[valuesById[104] = "PARAM_BIAS"] = 104;
    values[valuesById[105] = "PARAM_CHANGE_DEVICE_NAME"] = 105;
    values[valuesById[106] = "PARAM_RESOLUTION"] = 106;
    values[valuesById[107] = "PARAM_IMAGEPARAM_RESET"] = 107;
    values[valuesById[108] = "PARAM_SAVE_IMAGEPARAM_PRESET"] = 108;
    return values;
})();
 ...
 * @property {number} AUTOFRAMEING_MODE=7 AUTOFRAMEING_MODE value
 * @property {number} SMARTWHITEBOARD_MODE=8 SMARTWHITEBOARD_MODE value
 * @property {number} REGIONALTRACK_MODE=9 REGIONALTRACK_MODE value
 * @property {number} SMARTWHITEBOARD_QUERY=10 SMARTWHITEBOARD_QUERY value
 * @property {number} SMARTWHITEBOARD_CONFIG=11 SMARTWHITEBOARD_CONFIG value
 */
export const VideoModeType = $root.VideoModeType = (() => {
    ...
    values[valuesById[7] = "AUTOFRAMEING_MODE"] = 7;
    values[valuesById[8] = "SMARTWHITEBOARD_MODE"] = 8;
    values[valuesById[9] = "REGIONALTRACK_MODE"] = 9;
    values[valuesById[10] = "SMARTWHITEBOARD_QUERY"] = 10;
    values[valuesById[11] = "SMARTWHITEBOARD_CONFIG"] = 11;
    return values;
})();

/**
 * MettingCameraType enum.
 * @exports MettingCameraType
 * @enum {number}
 * @property {number} Link=0 Link value
 * @property {number} PUC2=1 PUC2 value
 * @property {number} PUC2_Flow=2 PUC2_Flow value
 * @property {number} PUC3=3 PUC3 value
 * @property {number} PUC3_Flow=4 PUC3_Flow value
 */
export const MettingCameraType = $root.MettingCameraType = (() => {
    const valuesById = {}, values = Object.create(valuesById);
    values[valuesById[0] = "Link"] = 0;
    values[valuesById[1] = "PUC2"] = 1;
    values[valuesById[2] = "PUC2_Flow"] = 2;
    values[valuesById[3] = "PUC3"] = 3;
    values[valuesById[4] = "PUC3_Flow"] = 4;
    return values;
})();
 ...
 * @property {number} XU_FIRMWARE_UPGRADE_CONTROL=8 XU_FIRMWARE_UPGRADE_CONTROL value
 ...
 * @property {number} XU_AF_MODE_CONTROL=15 XU_AF_MODE_CONTROL value
 * @property {number} XU_EXPOSURE_CURVE_CONTROL=16 XU_EXPOSURE_CURVE_CONTROL value
...
export const ControlSelector = $root.ControlSelector = (() => {
    ...
    values[valuesById[8] = "XU_FIRMWARE_UPGRADE_CONTROL"] = 8;
    ...
    values[valuesById[15] = "XU_AF_MODE_CONTROL"] = 15;
    values[valuesById[16] = "XU_EXPOSURE_CURVE_CONTROL"] = 16;
...
export const UVCRequest = $root.UVCRequest = (() => {
    ...
    UVCRequest.fromObject = function fromObject(object) {
        ...
        default:
            ...
            break;
        case "PARAM_MIRROR_VER":
        case 1:
            message.paramType = 1;
            break;
        case "PARAM_MIRROR_HOR":
        case 2:
            message.paramType = 2;
            break;
        case "PARAM_RESET_PTZ":
        case 3:
            message.paramType = 3;
            break;
        case "PARAM_ZOOM":
        ...
        case 11:
            ...
            break;
        case "PARAM_AUTO_TRACK":
        case 12:
            message.paramType = 12;
            break;
        case "PARAM_SINGLE_TAPTRACKING":
        case 13:
        ...
        case 17:
            ...
            break;
        case "PARAM_AUTO_FOCUS":
        case 18:
            message.paramType = 18;
            break;
        case "PARAM_MANUAL_FOCUS_VALUE":
        case 19:
        ...
        case 26:
            ...
            break;
        case "PARAM_AUTI_FLICK":
        case 27:
            message.paramType = 27;
            break;
        case "PARAM_BLUR_SWITCH":
        case 28:
            message.paramType = 28;
            break;
        case "PARAM_REPLACE_SWITCH":
        case 29:
            message.paramType = 29;
            break;
        case "PARAM_BLUR_RADIUS":
        case 30:
            message.paramType = 30;
            break;
        case "PARAM_BLUR_MODE":
        case 31:
            message.paramType = 31;
            break;
        case "PARAM_REPLACE_INDEX":
        case 32:
            message.paramType = 32;
            break;
        case "PARAM_AUDIO_CAPTURE_MODE":
        case 33:
            message.paramType = 33;
            break;
        case "PARAM_SMART_ADJUST":
        case 34:
            message.paramType = 34;
            break;
        case "PARAM_PRIVACY_MODE":
        case 35:
            message.paramType = 35;
            break;
        case "PARAM_ROLL_ADJUST":
        case 36:
            message.paramType = 36;
            break;
        case "PARAM_LOWER_RES":
        case 37:
            message.paramType = 37;
            break;
        case "PARAM_VERTICAL_SCREEN":
        case 38:
            message.paramType = 38;
            break;
        case "PARAM_GESTURE_TOTAL_SWITCH":
        case 39:
            message.paramType = 39;
            break;
        case "PARAM_GESTURE_PALM_SWITCH":
        case 40:
            message.paramType = 40;
            break;
        case "PARAM_GESTURE_V_SWITCH":
        case 41:
            message.paramType = 41;
            break;
        case "PARAM_GESTURE_L_SWITCH":
        case 42:
            message.paramType = 42;
            break;
        case "PARAM_GESTURE_ROCK_SWITCH":
        case 43:
            message.paramType = 43;
            break;
        case "PARAM_GESTURE_OK_SWITCH":
        case 44:
            message.paramType = 44;
            break;
        case "PARAM_HOST_PTZ_INFO":
        case 45:
            message.paramType = 45;
            break;
        case "PARAM_IMAGE_FILTER":
        case 46:
            message.paramType = 46;
            break;
        case "PARAM_IMAGE_TEMPLATE":
        case 47:
            message.paramType = 47;
            break;
        case "PARAM_CLOSE_BLUR_REPLACE":
        case 48:
            message.paramType = 48;
            break;
        case "PARAM_VIDEO_PRIVACY_MODE":
        case 49:
            message.paramType = 49;
            break;
        case "PARAM_FINE_TUNING":
        case 50:
            message.paramType = 50;
            break;
        case "PARAM_TRACK_FIRBOIDDEN_AREA":
        case 51:
            message.paramType = 51;
            break;
        case "PARAM_VER_SCREEN_LOCK":
        case 52:
            message.paramType = 52;
            break;
        case "PARAM_ROLL":
        case 100:
            message.paramType = 100;
            break;
        case "PARAM_PAN_TILT_ABSOLUTE":
        case 101:
            message.paramType = 101;
            break;
        case "PARAM_PAN_TILT_RELATIVE":
        case 102:
            message.paramType = 102;
            break;
        case "PARAM_PRESET_POSITION":
        case 103:
            message.paramType = 103;
            break;
        case "PARAM_BIAS":
        case 104:
            message.paramType = 104;
            break;
        case "PARAM_CHANGE_DEVICE_NAME":
        case 105:
            message.paramType = 105;
            break;
        case "PARAM_RESOLUTION":
        case 106:
            message.paramType = 106;
            break;
        case "PARAM_IMAGEPARAM_RESET":
        case 107:
            message.paramType = 107;
            break;
        case "PARAM_SAVE_IMAGEPARAM_PRESET":
        case 108:
            message.paramType = 108;
            break;
        }
    ...
    UVCRequest.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
            ...
            object.paramType = options.enums === String ? "PARAM_MIRROR_VER" : 1;
            if ($util.Long) {
...
export const UVCExtendRequest = $root.UVCExtendRequest = (() => {
    ...
    UVCExtendRequest.fromObject = function fromObject(object) {
        ...
        case 7:
            message.selector = 7;
            break;
        case "XU_FIRMWARE_UPGRADE_CONTROL":
        case 8:
            message.selector = 8;
            break;
        ...
        case 14:
            message.selector = 14;
            break;
        case "XU_AF_MODE_CONTROL":
        case 15:
            message.selector = 15;
            break;
        case "XU_EXPOSURE_CURVE_CONTROL":
        case 16:
            message.selector = 16;
            break;
...
export const DeviceInfoNotification = $root.DeviceInfoNotification = (() => {
     ...
     * @property {Array.<IDeviceBasicInfo>|null} [basicInfo] DeviceInfoNotification basicInfo
     ...
     * @member {Array.<IDeviceBasicInfo>} basicInfo
     * @memberof DeviceInfoNotification
     * @instance
     */
    DeviceInfoNotification.prototype.basicInfo = $util.emptyArray;
    ...
    DeviceInfoNotification.encode = function encode(message, writer) {
        ...
        if (message.basicInfo != null && message.basicInfo.length)
            for (let i = 0; i < message.basicInfo.length; ++i)
                $root.DeviceBasicInfo.encode(message.basicInfo[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        if (message.curDeviceSerialNum != null && Object.hasOwnProperty.call(message, "curDeviceSerialNum"))
            writer.uint32(/* id 2, wireType 2 =*/18).string(message.curDeviceSerialNum);
        return writer;
    };
        ...
        while (reader.pos < end) {
            ...
            case 1: {
                    if (!(message.basicInfo && message.basicInfo.length))
                        message.basicInfo = [];
                    message.basicInfo.push($root.DeviceBasicInfo.decode(reader, reader.uint32()));
                    break;
                }
            case 2: {
                    message.curDeviceSerialNum = reader.string();
    ...
    DeviceInfoNotification.verify = function verify(message) {
        ...
        if (message.basicInfo != null && message.hasOwnProperty("basicInfo")) {
            ...
            for (let i = 0; i < message.basicInfo.length; ++i) {
                let error = $root.DeviceBasicInfo.verify(message.basicInfo[i]);
                if (error)
    ...
    DeviceInfoNotification.fromObject = function fromObject(object) {
        ...
        if (object.basicInfo) {
            if (!Array.isArray(object.basicInfo))
                throw TypeError(".DeviceInfoNotification.basicInfo: array expected");
            message.basicInfo = [];
            for (let i = 0; i < object.basicInfo.length; ++i) {
                if (typeof object.basicInfo[i] !== "object")
                    throw TypeError(".DeviceInfoNotification.basicInfo: object expected");
                message.basicInfo[i] = $root.DeviceBasicInfo.fromObject(object.basicInfo[i]);
            }
        }
        if (object.curDeviceSerialNum != null)
            message.curDeviceSerialNum = String(object.curDeviceSerialNum);
    ...
    DeviceInfoNotification.toObject = function toObject(message, options) {
        ...
        if (message.basicInfo && message.basicInfo.length) {
            ...
            for (let j = 0; j < message.basicInfo.length; ++j)
                object.basicInfo[j] = $root.DeviceBasicInfo.toObject(message.basicInfo[j], options);
        }
        if (message.curDeviceSerialNum != null && message.hasOwnProperty("curDeviceSerialNum"))
            object.curDeviceSerialNum = message.curDeviceSerialNum;
        return object;
...
export const DeviceBasicInfo = $root.DeviceBasicInfo = (() => {

    /**
     * Properties of a DeviceBasicInfo.
     * @exports IDeviceBasicInfo
     * @interface IDeviceBasicInfo
     * @property {string|null} [deviceName] DeviceBasicInfo deviceName
     * @property {string|null} [serialNum] DeviceBasicInfo serialNum
     * @property {MettingCameraType|null} [cameraType] DeviceBasicInfo cameraType
     * @property {VideoModeType|null} [VideoModeType] DeviceBasicInfo VideoModeType
     * @property {IZoomInfo|null} [zoom] DeviceBasicInfo zoom
     * @property {Array.<IPresetPosInfo>|null} [presetInfos] DeviceBasicInfo presetInfos
     * @property {number|null} [curPresetPos] DeviceBasicInfo curPresetPos
     * @property {boolean|null} [verticallyMirror] DeviceBasicInfo verticallyMirror
     * @property {boolean|null} [horizontallyMirror] DeviceBasicInfo horizontallyMirror
     * @property {IDeviceSettingInfo|null} [settingInfos] DeviceBasicInfo settingInfos
     * @property {number|null} [hostPTZx] DeviceBasicInfo hostPTZx
     * @property {number|null} [hostPTZy] DeviceBasicInfo hostPTZy
     */

    /**
     * Constructs a new DeviceBasicInfo.
     * @exports DeviceBasicInfo
     * @classdesc Represents a DeviceBasicInfo.
     * @implements IDeviceBasicInfo
     * @constructor
     * @param {IDeviceBasicInfo=} [properties] Properties to set
     */
    function DeviceBasicInfo(properties) {
        this.presetInfos = [];
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
     ...
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.deviceName = "";
     ...
     * @instance
     */
    DeviceBasicInfo.prototype.serialNum = "";

    /**
     * DeviceBasicInfo cameraType.
     * @member {MettingCameraType} cameraType
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.cameraType = 0;

    /**
     * DeviceBasicInfo VideoModeType.
     * @member {VideoModeType} VideoModeType
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.VideoModeType = 0;

    /**
     * DeviceBasicInfo zoom.
     * @member {IZoomInfo|null|undefined} zoom
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.zoom = null;

    /**
     * DeviceBasicInfo presetInfos.
     * @member {Array.<IPresetPosInfo>} presetInfos
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.presetInfos = $util.emptyArray;
     ...
     * @instance
     */
    DeviceBasicInfo.prototype.curPresetPos = 0;

    /**
     * DeviceBasicInfo verticallyMirror.
     * @member {boolean} verticallyMirror
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.verticallyMirror = false;

    /**
     * DeviceBasicInfo horizontallyMirror.
     * @member {boolean} horizontallyMirror
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.horizontallyMirror = false;

    /**
     * DeviceBasicInfo settingInfos.
     * @member {IDeviceSettingInfo|null|undefined} settingInfos
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.settingInfos = null;

    /**
     * DeviceBasicInfo hostPTZx.
     * @member {number} hostPTZx
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.hostPTZx = 0;

    /**
     * DeviceBasicInfo hostPTZy.
     * @member {number} hostPTZy
     * @memberof DeviceBasicInfo
     * @instance
     */
    DeviceBasicInfo.prototype.hostPTZy = 0;
     ...
     * @static
     * @param {IDeviceBasicInfo=} [properties] Properties to set
     * @returns {DeviceBasicInfo} DeviceBasicInfo instance
     */
    DeviceBasicInfo.create = function create(properties) {
        return new DeviceBasicInfo(properties);
    };
     ...
     * @memberof DeviceBasicInfo
     * @static
     * @param {IDeviceBasicInfo} message DeviceBasicInfo message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    DeviceBasicInfo.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        ...
        if (message.VideoModeType != null && Object.hasOwnProperty.call(message, "VideoModeType"))
            writer.uint32(/* id 4, wireType 0 =*/32).int32(message.VideoModeType);
        if (message.zoom != null && Object.hasOwnProperty.call(message, "zoom"))
            $root.ZoomInfo.encode(message.zoom, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
        if (message.presetInfos != null && message.presetInfos.length)
            for (let i = 0; i < message.presetInfos.length; ++i)
                $root.PresetPosInfo.encode(message.presetInfos[i], writer.uint32(/* id 6, wireType 2 =*/50).fork()).ldelim();
        if (message.curPresetPos != null && Object.hasOwnProperty.call(message, "curPresetPos"))
            writer.uint32(/* id 7, wireType 0 =*/56).int32(message.curPresetPos);
        if (message.verticallyMirror != null && Object.hasOwnProperty.call(message, "verticallyMirror"))
            writer.uint32(/* id 8, wireType 0 =*/64).bool(message.verticallyMirror);
        if (message.horizontallyMirror != null && Object.hasOwnProperty.call(message, "horizontallyMirror"))
            writer.uint32(/* id 9, wireType 0 =*/72).bool(message.horizontallyMirror);
        if (message.settingInfos != null && Object.hasOwnProperty.call(message, "settingInfos"))
            $root.DeviceSettingInfo.encode(message.settingInfos, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
        if (message.hostPTZx != null && Object.hasOwnProperty.call(message, "hostPTZx"))
            writer.uint32(/* id 11, wireType 5 =*/93).float(message.hostPTZx);
        if (message.hostPTZy != null && Object.hasOwnProperty.call(message, "hostPTZy"))
            writer.uint32(/* id 12, wireType 5 =*/101).float(message.hostPTZy);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DeviceBasicInfo.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {DeviceBasicInfo} DeviceBasicInfo
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceBasicInfo.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DeviceBasicInfo();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 4: {
                    message.VideoModeType = reader.int32();
                    break;
                }
            case 5: {
                    message.zoom = $root.ZoomInfo.decode(reader, reader.uint32());
                    break;
                }
            case 6: {
                    if (!(message.presetInfos && message.presetInfos.length))
                        message.presetInfos = [];
                    message.presetInfos.push($root.PresetPosInfo.decode(reader, reader.uint32()));
                    break;
                }
            case 7: {
            ...
            case 8: {
                    message.verticallyMirror = reader.bool();
                    break;
                }
            case 9: {
                    message.horizontallyMirror = reader.bool();
                    break;
                }
            case 10: {
                    message.settingInfos = $root.DeviceSettingInfo.decode(reader, reader.uint32());
                    break;
                }
            case 11: {
                    message.hostPTZx = reader.float();
                    break;
                }
            case 12: {
                    message.hostPTZy = reader.float();
                    break;
                }
            default:
                reader.skipType(tag & 7);
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceBasicInfo.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    DeviceBasicInfo.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        ...
        if (message.VideoModeType != null && message.hasOwnProperty("VideoModeType"))
            switch (message.VideoModeType) {
            default:
                return "VideoModeType: enum value expected";
            case 0:
            case 1:
            case 2:
            case 4:
        ...
        if (message.zoom != null && message.hasOwnProperty("zoom")) {
            let error = $root.ZoomInfo.verify(message.zoom);
            if (error)
                return "zoom." + error;
        }
        if (message.presetInfos != null && message.hasOwnProperty("presetInfos")) {
            ...
            for (let i = 0; i < message.presetInfos.length; ++i) {
                let error = $root.PresetPosInfo.verify(message.presetInfos[i]);
                if (error)
        ...
        if (message.verticallyMirror != null && message.hasOwnProperty("verticallyMirror"))
            if (typeof message.verticallyMirror !== "boolean")
                return "verticallyMirror: boolean expected";
        if (message.horizontallyMirror != null && message.hasOwnProperty("horizontallyMirror"))
            if (typeof message.horizontallyMirror !== "boolean")
                return "horizontallyMirror: boolean expected";
        if (message.settingInfos != null && message.hasOwnProperty("settingInfos")) {
            let error = $root.DeviceSettingInfo.verify(message.settingInfos);
            if (error)
                return "settingInfos." + error;
        }
        if (message.hostPTZx != null && message.hasOwnProperty("hostPTZx"))
            if (typeof message.hostPTZx !== "number")
                return "hostPTZx: number expected";
        if (message.hostPTZy != null && message.hasOwnProperty("hostPTZy"))
            if (typeof message.hostPTZy !== "number")
                return "hostPTZy: number expected";
        return null;
    };
     ...
     * @returns {DeviceBasicInfo} DeviceBasicInfo
     */
    DeviceBasicInfo.fromObject = function fromObject(object) {
        if (object instanceof $root.DeviceBasicInfo)
            return object;
        let message = new $root.DeviceBasicInfo();
        ...
        case "PUC3":
        case 3:
            message.cameraType = 3;
            break;
        case "PUC3_Flow":
        case 4:
            message.cameraType = 4;
            break;
        }
        switch (object.VideoModeType) {
        default:
            if (typeof object.VideoModeType === "number") {
                message.VideoModeType = object.VideoModeType;
                break;
            }
            break;
        case "NORMAL_MODE":
        case 0:
            message.VideoModeType = 0;
            break;
        case "AUTO_COMPOSITION":
        case 1:
            message.VideoModeType = 1;
            break;
        case "TRACKING_MODE":
        case 2:
            message.VideoModeType = 2;
            break;
        case "WHITEBOARD_MODE":
        case 4:
            message.VideoModeType = 4;
            break;
        case "OVERHEAD_MODE":
        case 5:
            message.VideoModeType = 5;
            break;
        case "DESKVIEW_MODE":
        case 6:
            message.VideoModeType = 6;
            break;
        case "AUTOFRAMEING_MODE":
        case 7:
            message.VideoModeType = 7;
            break;
        case "SMARTWHITEBOARD_MODE":
        case 8:
            message.VideoModeType = 8;
            break;
        case "REGIONALTRACK_MODE":
        case 9:
            message.VideoModeType = 9;
            break;
        case "SMARTWHITEBOARD_QUERY":
        case 10:
            message.VideoModeType = 10;
            break;
        case "SMARTWHITEBOARD_CONFIG":
        case 11:
            message.VideoModeType = 11;
            break;
        }
        if (object.zoom != null) {
            if (typeof object.zoom !== "object")
                throw TypeError(".DeviceBasicInfo.zoom: object expected");
            message.zoom = $root.ZoomInfo.fromObject(object.zoom);
        }
        if (object.presetInfos) {
            if (!Array.isArray(object.presetInfos))
                throw TypeError(".DeviceBasicInfo.presetInfos: array expected");
            message.presetInfos = [];
            for (let i = 0; i < object.presetInfos.length; ++i) {
                if (typeof object.presetInfos[i] !== "object")
                    throw TypeError(".DeviceBasicInfo.presetInfos: object expected");
                message.presetInfos[i] = $root.PresetPosInfo.fromObject(object.presetInfos[i]);
            }
        }
        if (object.curPresetPos != null)
            message.curPresetPos = object.curPresetPos | 0;
        if (object.verticallyMirror != null)
            message.verticallyMirror = Boolean(object.verticallyMirror);
        if (object.horizontallyMirror != null)
            message.horizontallyMirror = Boolean(object.horizontallyMirror);
        if (object.settingInfos != null) {
            if (typeof object.settingInfos !== "object")
                throw TypeError(".DeviceBasicInfo.settingInfos: object expected");
            message.settingInfos = $root.DeviceSettingInfo.fromObject(object.settingInfos);
        }
        if (object.hostPTZx != null)
            message.hostPTZx = Number(object.hostPTZx);
        if (object.hostPTZy != null)
            message.hostPTZy = Number(object.hostPTZy);
        return message;
    };
     ...
     * @memberof DeviceBasicInfo
     * @static
     * @param {DeviceBasicInfo} message DeviceBasicInfo
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    DeviceBasicInfo.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.arrays || options.defaults)
        ...
        if (options.defaults) {
            object.deviceName = "";
            object.serialNum = "";
            object.cameraType = options.enums === String ? "Link" : 0;
            object.VideoModeType = options.enums === String ? "NORMAL_MODE" : 0;
            object.zoom = null;
            object.curPresetPos = 0;
            object.verticallyMirror = false;
            object.horizontallyMirror = false;
            object.settingInfos = null;
            object.hostPTZx = 0;
            object.hostPTZy = 0;
        }
        if (message.deviceName != null && message.hasOwnProperty("deviceName"))
        ...
        if (message.cameraType != null && message.hasOwnProperty("cameraType"))
            object.cameraType = options.enums === String ? $root.MettingCameraType[message.cameraType] === undefined ? message.cameraType : $root.MettingCameraType[message.cameraType] : message.cameraType;
        if (message.VideoModeType != null && message.hasOwnProperty("VideoModeType"))
            object.VideoModeType = options.enums === String ? $root.VideoModeType[message.VideoModeType] === undefined ? message.VideoModeType : $root.VideoModeType[message.VideoModeType] : message.VideoModeType;
        if (message.zoom != null && message.hasOwnProperty("zoom"))
            object.zoom = $root.ZoomInfo.toObject(message.zoom, options);
        if (message.presetInfos && message.presetInfos.length) {
            object.presetInfos = [];
            for (let j = 0; j < message.presetInfos.length; ++j)
                object.presetInfos[j] = $root.PresetPosInfo.toObject(message.presetInfos[j], options);
        }
        if (message.curPresetPos != null && message.hasOwnProperty("curPresetPos"))
            object.curPresetPos = message.curPresetPos;
        if (message.verticallyMirror != null && message.hasOwnProperty("verticallyMirror"))
            object.verticallyMirror = message.verticallyMirror;
        if (message.horizontallyMirror != null && message.hasOwnProperty("horizontallyMirror"))
            object.horizontallyMirror = message.horizontallyMirror;
        if (message.settingInfos != null && message.hasOwnProperty("settingInfos"))
            object.settingInfos = $root.DeviceSettingInfo.toObject(message.settingInfos, options);
        if (message.hostPTZx != null && message.hasOwnProperty("hostPTZx"))
            object.hostPTZx = options.json && !isFinite(message.hostPTZx) ? String(message.hostPTZx) : message.hostPTZx;
        if (message.hostPTZy != null && message.hasOwnProperty("hostPTZy"))
            object.hostPTZy = options.json && !isFinite(message.hostPTZy) ? String(message.hostPTZy) : message.hostPTZy;
        return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    DeviceBasicInfo.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    DeviceBasicInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/DeviceBasicInfo";
    };

    return DeviceBasicInfo;
})();

export const ZoomInfo = $root.ZoomInfo = (() => {
     ...
     * @constructor
     * @param {IZoomInfo=} [properties] Properties to set
     */
     ...
     * @static
     * @param {IZoomInfo=} [properties] Properties to set
     * @returns {ZoomInfo} ZoomInfo instance
     */
     ...
     * @memberof ZoomInfo
     * @static
     * @param {IZoomInfo} message ZoomInfo message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ...
    ZoomInfo.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ZoomInfo();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    ZoomInfo.fromObject = function fromObject(object) {
        if (object instanceof $root.ZoomInfo)
            return object;
        let message = new $root.ZoomInfo();
     ...
     * @memberof ZoomInfo
     * @static
     * @param {ZoomInfo} message ZoomInfo
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ...
    ZoomInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        ...
        return typeUrlPrefix + "/ZoomInfo";
    };

    return ZoomInfo;
})();

export const PresetPosInfo = $root.PresetPosInfo = (() => {

    /**
     * Properties of a PresetPosInfo.
     * @exports IPresetPosInfo
     * @interface IPresetPosInfo
     * @property {string|null} [name] PresetPosInfo name
     * @property {number|null} [index] PresetPosInfo index
     */

    /**
     * Constructs a new PresetPosInfo.
     * @exports PresetPosInfo
     * @classdesc Represents a PresetPosInfo.
     * @implements IPresetPosInfo
     * @constructor
     * @param {IPresetPosInfo=} [properties] Properties to set
     */
     ...
     * @instance
     */
    PresetPosInfo.prototype.index = 0;
     ...
     * @static
     * @param {IPresetPosInfo=} [properties] Properties to set
     * @returns {PresetPosInfo} PresetPosInfo instance
     */
     ...
     * @memberof PresetPosInfo
     * @static
     * @param {IPresetPosInfo} message PresetPosInfo message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {PresetPosInfo} PresetPosInfo
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    PresetPosInfo.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PresetPosInfo();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
    ...
    PresetPosInfo.fromObject = function fromObject(object) {
        if (object instanceof $root.PresetPosInfo)
            return object;
        let message = new $root.PresetPosInfo();
        if (object.name != null)
     ...
     * @memberof PresetPosInfo
     * @static
     * @param {PresetPosInfo} message PresetPosInfo
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ...
    PresetPosInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        ...
        return typeUrlPrefix + "/PresetPosInfo";
    };

    return PresetPosInfo;
})();

export const DeviceSettingInfo = $root.DeviceSettingInfo = (() => {

    /**
     * Properties of a DeviceSettingInfo.
     * @exports IDeviceSettingInfo
     * @interface IDeviceSettingInfo
     * @property {number|null} [compositionStyle] DeviceSettingInfo compositionStyle
     * @property {number|null} [trackSpeed] DeviceSettingInfo trackSpeed
     * @property {boolean|null} [enableAutoTrack] DeviceSettingInfo enableAutoTrack
     * @property {boolean|null} [enableSingleTapTracking] DeviceSettingInfo enableSingleTapTracking
     * @property {boolean|null} [compositionStyleEnabled] DeviceSettingInfo compositionStyleEnabled
     * @property {boolean|null} [hdr] DeviceSettingInfo hdr
     * @property {number|null} [brightness] DeviceSettingInfo brightness
     * @property {number|null} [contrast] DeviceSettingInfo contrast
     * @property {number|null} [satutation] DeviceSettingInfo satutation
     * @property {number|null} [sharpening] DeviceSettingInfo sharpening
     * @property {boolean|null} [imageParamReset] DeviceSettingInfo imageParamReset
     * @property {boolean|null} [autoExposure] DeviceSettingInfo autoExposure
     * @property {number|null} [isoValue] DeviceSettingInfo isoValue
     * @property {number|null} [shutterValue] DeviceSettingInfo shutterValue
     * @property {number|null} [exposureCompensation] DeviceSettingInfo exposureCompensation
     * @property {boolean|null} [autoWhiteBalance] DeviceSettingInfo autoWhiteBalance
     * @property {number|null} [whiteBalanceValue] DeviceSettingInfo whiteBalanceValue
     * @property {Array.<IImageParamPreset>|null} [imageParamPresetInfos] DeviceSettingInfo imageParamPresetInfos
     * @property {Array.<IImageFilter>|null} [imageFilterInfos] DeviceSettingInfo imageFilterInfos
     * @property {number|null} [curImageParam] DeviceSettingInfo curImageParam
     * @property {number|null} [curImageFilter] DeviceSettingInfo curImageFilter
     * @property {boolean|null} [supportVirtualCamera] DeviceSettingInfo supportVirtualCamera
     * @property {boolean|null} [enableBackGroudBlur] DeviceSettingInfo enableBackGroudBlur
     * @property {boolean|null} [enableBackGroudReplace] DeviceSettingInfo enableBackGroudReplace
     * @property {Array.<number>|null} [supportBlurModeList] DeviceSettingInfo supportBlurModeList
     * @property {number|null} [replaceIndex] DeviceSettingInfo replaceIndex
     * @property {number|null} [antiFlicker] DeviceSettingInfo antiFlicker
     * @property {number|null} [audioCaptureMode] DeviceSettingInfo audioCaptureMode
     * @property {number|null} [curBlurMode] DeviceSettingInfo curBlurMode
     * @property {boolean|null} [enableSmartAdjust] DeviceSettingInfo enableSmartAdjust
     * @property {boolean|null} [enablePrivacyMode] DeviceSettingInfo enablePrivacyMode
     * @property {boolean|null} [enableRollAdjust] DeviceSettingInfo enableRollAdjust
     * @property {boolean|null} [enableLowerRes] DeviceSettingInfo enableLowerRes
     * @property {number|null} [blurRadius] DeviceSettingInfo blurRadius
     * @property {boolean|null} [gestureEnabled] DeviceSettingInfo gestureEnabled
     * @property {boolean|null} [gesturePlamEnabled] DeviceSettingInfo gesturePlamEnabled
     * @property {boolean|null} [gestureVEnabled] DeviceSettingInfo gestureVEnabled
     * @property {boolean|null} [gestureLEnabled] DeviceSettingInfo gestureLEnabled
     * @property {boolean|null} [gestureRockEnabled] DeviceSettingInfo gestureRockEnabled
     * @property {boolean|null} [gestureOkEnabled] DeviceSettingInfo gestureOkEnabled
     * @property {boolean|null} [enableAutoFocus] DeviceSettingInfo enableAutoFocus
     * @property {number|null} [maualFocus] DeviceSettingInfo maualFocus
     * @property {boolean|null} [enableVerticalScreen] DeviceSettingInfo enableVerticalScreen
     * @property {boolean|null} [videoPrivacyMode] DeviceSettingInfo videoPrivacyMode
     * @property {string|null} [resolution] DeviceSettingInfo resolution
     * @property {number|null} [funeTuningValue] DeviceSettingInfo funeTuningValue
     * @property {boolean|null} [verScreenLock] DeviceSettingInfo verScreenLock
     * @property {boolean|null} [enableTrackForiddenArea] DeviceSettingInfo enableTrackForiddenArea
     */

    /**
     * Constructs a new DeviceSettingInfo.
     * @exports DeviceSettingInfo
     * @classdesc Represents a DeviceSettingInfo.
     * @implements IDeviceSettingInfo
     * @constructor
     * @param {IDeviceSettingInfo=} [properties] Properties to set
     */
    function DeviceSettingInfo(properties) {
        this.imageParamPresetInfos = [];
        this.imageFilterInfos = [];
        this.supportBlurModeList = [];
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.compositionStyle = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.trackSpeed = 0;

    /**
     * DeviceSettingInfo enableAutoTrack.
     * @member {boolean} enableAutoTrack
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableAutoTrack = false;

    /**
     * DeviceSettingInfo enableSingleTapTracking.
     * @member {boolean} enableSingleTapTracking
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableSingleTapTracking = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.compositionStyleEnabled = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.hdr = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.brightness = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.contrast = 0;

    /**
     * DeviceSettingInfo satutation.
     * @member {number} satutation
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.satutation = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.sharpening = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.imageParamReset = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.autoExposure = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.isoValue = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.shutterValue = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.exposureCompensation = 0;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.autoWhiteBalance = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.whiteBalanceValue = 0;

    /**
     * DeviceSettingInfo imageParamPresetInfos.
     * @member {Array.<IImageParamPreset>} imageParamPresetInfos
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.imageParamPresetInfos = $util.emptyArray;

    /**
     * DeviceSettingInfo imageFilterInfos.
     * @member {Array.<IImageFilter>} imageFilterInfos
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.imageFilterInfos = $util.emptyArray;

    /**
     * DeviceSettingInfo curImageParam.
     * @member {number} curImageParam
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.curImageParam = 0;

    /**
     * DeviceSettingInfo curImageFilter.
     * @member {number} curImageFilter
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.curImageFilter = 0;

    /**
     * DeviceSettingInfo supportVirtualCamera.
     * @member {boolean} supportVirtualCamera
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.supportVirtualCamera = false;

    /**
     * DeviceSettingInfo enableBackGroudBlur.
     * @member {boolean} enableBackGroudBlur
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableBackGroudBlur = false;

    /**
     * DeviceSettingInfo enableBackGroudReplace.
     * @member {boolean} enableBackGroudReplace
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableBackGroudReplace = false;

    /**
     * DeviceSettingInfo supportBlurModeList.
     * @member {Array.<number>} supportBlurModeList
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.supportBlurModeList = $util.emptyArray;

    /**
     * DeviceSettingInfo replaceIndex.
     * @member {number} replaceIndex
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.replaceIndex = 0;

    /**
     * DeviceSettingInfo antiFlicker.
     * @member {number} antiFlicker
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.antiFlicker = 0;

    /**
     * DeviceSettingInfo audioCaptureMode.
     * @member {number} audioCaptureMode
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.audioCaptureMode = 0;

    /**
     * DeviceSettingInfo curBlurMode.
     * @member {number} curBlurMode
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.curBlurMode = 0;

    /**
     * DeviceSettingInfo enableSmartAdjust.
     * @member {boolean} enableSmartAdjust
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableSmartAdjust = false;

    /**
     * DeviceSettingInfo enablePrivacyMode.
     * @member {boolean} enablePrivacyMode
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enablePrivacyMode = false;

    /**
     * DeviceSettingInfo enableRollAdjust.
     * @member {boolean} enableRollAdjust
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableRollAdjust = false;

    /**
     * DeviceSettingInfo enableLowerRes.
     * @member {boolean} enableLowerRes
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableLowerRes = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.blurRadius = 0;

    /**
     * DeviceSettingInfo gestureEnabled.
     * @member {boolean} gestureEnabled
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.gestureEnabled = false;

    /**
     * DeviceSettingInfo gesturePlamEnabled.
     * @member {boolean} gesturePlamEnabled
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.gesturePlamEnabled = false;

    /**
     * DeviceSettingInfo gestureVEnabled.
     * @member {boolean} gestureVEnabled
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.gestureVEnabled = false;

    /**
     * DeviceSettingInfo gestureLEnabled.
     * @member {boolean} gestureLEnabled
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.gestureLEnabled = false;

    /**
     * DeviceSettingInfo gestureRockEnabled.
     * @member {boolean} gestureRockEnabled
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.gestureRockEnabled = false;

    /**
     * DeviceSettingInfo gestureOkEnabled.
     * @member {boolean} gestureOkEnabled
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.gestureOkEnabled = false;

    /**
     * DeviceSettingInfo enableAutoFocus.
     * @member {boolean} enableAutoFocus
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableAutoFocus = false;

    /**
     * DeviceSettingInfo maualFocus.
     * @member {number} maualFocus
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.maualFocus = 0;

    /**
     * DeviceSettingInfo enableVerticalScreen.
     * @member {boolean} enableVerticalScreen
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableVerticalScreen = false;

    /**
     * DeviceSettingInfo videoPrivacyMode.
     * @member {boolean} videoPrivacyMode
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.videoPrivacyMode = false;
     ...
     * @instance
     */
    DeviceSettingInfo.prototype.resolution = "";

    /**
     * DeviceSettingInfo funeTuningValue.
     * @member {number} funeTuningValue
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.funeTuningValue = 0;

    /**
     * DeviceSettingInfo verScreenLock.
     * @member {boolean} verScreenLock
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.verScreenLock = false;

    /**
     * DeviceSettingInfo enableTrackForiddenArea.
     * @member {boolean} enableTrackForiddenArea
     * @memberof DeviceSettingInfo
     * @instance
     */
    DeviceSettingInfo.prototype.enableTrackForiddenArea = false;
     ...
     * @static
     * @param {IDeviceSettingInfo=} [properties] Properties to set
     * @returns {DeviceSettingInfo} DeviceSettingInfo instance
     */
    DeviceSettingInfo.create = function create(properties) {
        return new DeviceSettingInfo(properties);
    };
     ...
     * @memberof DeviceSettingInfo
     * @static
     * @param {IDeviceSettingInfo} message DeviceSettingInfo message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    DeviceSettingInfo.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.compositionStyle != null && Object.hasOwnProperty.call(message, "compositionStyle"))
            writer.uint32(/* id 1, wireType 0 =*/8).int32(message.compositionStyle);
        if (message.trackSpeed != null && Object.hasOwnProperty.call(message, "trackSpeed"))
            writer.uint32(/* id 2, wireType 0 =*/16).int32(message.trackSpeed);
        if (message.enableAutoTrack != null && Object.hasOwnProperty.call(message, "enableAutoTrack"))
            writer.uint32(/* id 4, wireType 0 =*/32).bool(message.enableAutoTrack);
        if (message.enableSingleTapTracking != null && Object.hasOwnProperty.call(message, "enableSingleTapTracking"))
            writer.uint32(/* id 5, wireType 0 =*/40).bool(message.enableSingleTapTracking);
        if (message.compositionStyleEnabled != null && Object.hasOwnProperty.call(message, "compositionStyleEnabled"))
            writer.uint32(/* id 6, wireType 0 =*/48).bool(message.compositionStyleEnabled);
        ...
        if (message.satutation != null && Object.hasOwnProperty.call(message, "satutation"))
            writer.uint32(/* id 14, wireType 0 =*/112).int32(message.satutation);
        ...
        if (message.imageParamPresetInfos != null && message.imageParamPresetInfos.length)
            for (let i = 0; i < message.imageParamPresetInfos.length; ++i)
                $root.ImageParamPreset.encode(message.imageParamPresetInfos[i], writer.uint32(/* id 23, wireType 2 =*/186).fork()).ldelim();
        if (message.imageFilterInfos != null && message.imageFilterInfos.length)
            for (let i = 0; i < message.imageFilterInfos.length; ++i)
                $root.ImageFilter.encode(message.imageFilterInfos[i], writer.uint32(/* id 24, wireType 2 =*/194).fork()).ldelim();
        if (message.curImageParam != null && Object.hasOwnProperty.call(message, "curImageParam"))
            writer.uint32(/* id 25, wireType 0 =*/200).int32(message.curImageParam);
        if (message.curImageFilter != null && Object.hasOwnProperty.call(message, "curImageFilter"))
            writer.uint32(/* id 26, wireType 0 =*/208).int32(message.curImageFilter);
        if (message.supportVirtualCamera != null && Object.hasOwnProperty.call(message, "supportVirtualCamera"))
            writer.uint32(/* id 27, wireType 0 =*/216).bool(message.supportVirtualCamera);
        if (message.enableBackGroudBlur != null && Object.hasOwnProperty.call(message, "enableBackGroudBlur"))
            writer.uint32(/* id 28, wireType 0 =*/224).bool(message.enableBackGroudBlur);
        if (message.enableBackGroudReplace != null && Object.hasOwnProperty.call(message, "enableBackGroudReplace"))
            writer.uint32(/* id 29, wireType 0 =*/232).bool(message.enableBackGroudReplace);
        if (message.supportBlurModeList != null && message.supportBlurModeList.length) {
            writer.uint32(/* id 31, wireType 2 =*/250).fork();
            for (let i = 0; i < message.supportBlurModeList.length; ++i)
                writer.int32(message.supportBlurModeList[i]);
            writer.ldelim();
        }
        if (message.replaceIndex != null && Object.hasOwnProperty.call(message, "replaceIndex"))
            writer.uint32(/* id 32, wireType 0 =*/256).int32(message.replaceIndex);
        if (message.antiFlicker != null && Object.hasOwnProperty.call(message, "antiFlicker"))
            writer.uint32(/* id 34, wireType 0 =*/272).int32(message.antiFlicker);
        if (message.audioCaptureMode != null && Object.hasOwnProperty.call(message, "audioCaptureMode"))
            writer.uint32(/* id 35, wireType 0 =*/280).int32(message.audioCaptureMode);
        if (message.curBlurMode != null && Object.hasOwnProperty.call(message, "curBlurMode"))
            writer.uint32(/* id 36, wireType 0 =*/288).int32(message.curBlurMode);
        if (message.enableSmartAdjust != null && Object.hasOwnProperty.call(message, "enableSmartAdjust"))
            writer.uint32(/* id 37, wireType 0 =*/296).bool(message.enableSmartAdjust);
        if (message.enablePrivacyMode != null && Object.hasOwnProperty.call(message, "enablePrivacyMode"))
            writer.uint32(/* id 38, wireType 0 =*/304).bool(message.enablePrivacyMode);
        if (message.enableRollAdjust != null && Object.hasOwnProperty.call(message, "enableRollAdjust"))
            writer.uint32(/* id 39, wireType 0 =*/312).bool(message.enableRollAdjust);
        if (message.enableLowerRes != null && Object.hasOwnProperty.call(message, "enableLowerRes"))
            writer.uint32(/* id 40, wireType 0 =*/320).bool(message.enableLowerRes);
        if (message.blurRadius != null && Object.hasOwnProperty.call(message, "blurRadius"))
            writer.uint32(/* id 41, wireType 0 =*/328).int32(message.blurRadius);
        if (message.gestureEnabled != null && Object.hasOwnProperty.call(message, "gestureEnabled"))
            writer.uint32(/* id 42, wireType 0 =*/336).bool(message.gestureEnabled);
        if (message.gesturePlamEnabled != null && Object.hasOwnProperty.call(message, "gesturePlamEnabled"))
            writer.uint32(/* id 43, wireType 0 =*/344).bool(message.gesturePlamEnabled);
        if (message.gestureVEnabled != null && Object.hasOwnProperty.call(message, "gestureVEnabled"))
            writer.uint32(/* id 44, wireType 0 =*/352).bool(message.gestureVEnabled);
        if (message.gestureLEnabled != null && Object.hasOwnProperty.call(message, "gestureLEnabled"))
            writer.uint32(/* id 45, wireType 0 =*/360).bool(message.gestureLEnabled);
        if (message.gestureRockEnabled != null && Object.hasOwnProperty.call(message, "gestureRockEnabled"))
            writer.uint32(/* id 46, wireType 0 =*/368).bool(message.gestureRockEnabled);
        if (message.gestureOkEnabled != null && Object.hasOwnProperty.call(message, "gestureOkEnabled"))
            writer.uint32(/* id 47, wireType 0 =*/376).bool(message.gestureOkEnabled);
        if (message.enableAutoFocus != null && Object.hasOwnProperty.call(message, "enableAutoFocus"))
            writer.uint32(/* id 48, wireType 0 =*/384).bool(message.enableAutoFocus);
        if (message.maualFocus != null && Object.hasOwnProperty.call(message, "maualFocus"))
            writer.uint32(/* id 49, wireType 0 =*/392).int32(message.maualFocus);
        if (message.enableVerticalScreen != null && Object.hasOwnProperty.call(message, "enableVerticalScreen"))
            writer.uint32(/* id 50, wireType 0 =*/400).bool(message.enableVerticalScreen);
        if (message.videoPrivacyMode != null && Object.hasOwnProperty.call(message, "videoPrivacyMode"))
            writer.uint32(/* id 51, wireType 0 =*/408).bool(message.videoPrivacyMode);
        if (message.resolution != null && Object.hasOwnProperty.call(message, "resolution"))
            writer.uint32(/* id 52, wireType 2 =*/418).string(message.resolution);
        if (message.funeTuningValue != null && Object.hasOwnProperty.call(message, "funeTuningValue"))
            writer.uint32(/* id 53, wireType 5 =*/429).float(message.funeTuningValue);
        if (message.verScreenLock != null && Object.hasOwnProperty.call(message, "verScreenLock"))
            writer.uint32(/* id 54, wireType 0 =*/432).bool(message.verScreenLock);
        if (message.enableTrackForiddenArea != null && Object.hasOwnProperty.call(message, "enableTrackForiddenArea"))
            writer.uint32(/* id 55, wireType 0 =*/440).bool(message.enableTrackForiddenArea);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    DeviceSettingInfo.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {DeviceSettingInfo} DeviceSettingInfo
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceSettingInfo.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.DeviceSettingInfo();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
            ...
            case 4: {
                    message.enableAutoTrack = reader.bool();
                    break;
                }
            case 5: {
                    message.enableSingleTapTracking = reader.bool();
                    break;
                }
            case 6: {
            ...
            case 14: {
                    message.satutation = reader.int32();
                    break;
                }
            case 15: {
            ...
            case 23: {
                    if (!(message.imageParamPresetInfos && message.imageParamPresetInfos.length))
                        message.imageParamPresetInfos = [];
                    message.imageParamPresetInfos.push($root.ImageParamPreset.decode(reader, reader.uint32()));
                    break;
                }
            case 24: {
                    if (!(message.imageFilterInfos && message.imageFilterInfos.length))
                        message.imageFilterInfos = [];
                    message.imageFilterInfos.push($root.ImageFilter.decode(reader, reader.uint32()));
                    break;
                }
            case 25: {
                    message.curImageParam = reader.int32();
                    break;
                }
            case 26: {
                    message.curImageFilter = reader.int32();
                    break;
                }
            case 27: {
                    message.supportVirtualCamera = reader.bool();
                    break;
                }
            case 28: {
                    message.enableBackGroudBlur = reader.bool();
                    break;
                }
            case 29: {
                    message.enableBackGroudReplace = reader.bool();
                    break;
                }
            case 31: {
                    if (!(message.supportBlurModeList && message.supportBlurModeList.length))
                        message.supportBlurModeList = [];
                    if ((tag & 7) === 2) {
                        let end2 = reader.uint32() + reader.pos;
                        while (reader.pos < end2)
                            message.supportBlurModeList.push(reader.int32());
                    } else
                        message.supportBlurModeList.push(reader.int32());
                    break;
                }
            ...
            case 35: {
                    message.audioCaptureMode = reader.int32();
                    break;
                }
            case 36: {
                    message.curBlurMode = reader.int32();
                    break;
                }
            case 37: {
                    message.enableSmartAdjust = reader.bool();
                    break;
                }
            case 38: {
                    message.enablePrivacyMode = reader.bool();
                    break;
                }
            case 39: {
                    message.enableRollAdjust = reader.bool();
                    break;
                }
            case 40: {
                    message.enableLowerRes = reader.bool();
                    break;
                }
            case 41: {
                    message.blurRadius = reader.int32();
                    break;
                }
            case 42: {
                    message.gestureEnabled = reader.bool();
                    break;
                }
            case 43: {
                    message.gesturePlamEnabled = reader.bool();
                    break;
                }
            case 44: {
                    message.gestureVEnabled = reader.bool();
                    break;
                }
            case 45: {
                    message.gestureLEnabled = reader.bool();
                    break;
                }
            case 46: {
                    message.gestureRockEnabled = reader.bool();
                    break;
                }
            case 47: {
                    message.gestureOkEnabled = reader.bool();
                    break;
                }
            case 48: {
                    message.enableAutoFocus = reader.bool();
                    break;
                }
            case 49: {
                    message.maualFocus = reader.int32();
                    break;
                }
            case 50: {
                    message.enableVerticalScreen = reader.bool();
                    break;
                }
            case 51: {
                    message.videoPrivacyMode = reader.bool();
                    break;
                }
            case 52: {
            ...
            case 53: {
                    message.funeTuningValue = reader.float();
                    break;
                }
            case 54: {
                    message.verScreenLock = reader.bool();
                    break;
                }
            case 55: {
                    message.enableTrackForiddenArea = reader.bool();
                    break;
                }
            default:
                reader.skipType(tag & 7);
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    DeviceSettingInfo.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    DeviceSettingInfo.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        ...
        if (message.enableAutoTrack != null && message.hasOwnProperty("enableAutoTrack"))
            if (typeof message.enableAutoTrack !== "boolean")
                return "enableAutoTrack: boolean expected";
        if (message.enableSingleTapTracking != null && message.hasOwnProperty("enableSingleTapTracking"))
            if (typeof message.enableSingleTapTracking !== "boolean")
                return "enableSingleTapTracking: boolean expected";
        ...
        if (message.satutation != null && message.hasOwnProperty("satutation"))
            if (!$util.isInteger(message.satutation))
                return "satutation: integer expected";
        ...
        if (message.imageParamPresetInfos != null && message.hasOwnProperty("imageParamPresetInfos")) {
            if (!Array.isArray(message.imageParamPresetInfos))
                return "imageParamPresetInfos: array expected";
            for (let i = 0; i < message.imageParamPresetInfos.length; ++i) {
                let error = $root.ImageParamPreset.verify(message.imageParamPresetInfos[i]);
                if (error)
                    return "imageParamPresetInfos." + error;
            }
        }
        if (message.imageFilterInfos != null && message.hasOwnProperty("imageFilterInfos")) {
            if (!Array.isArray(message.imageFilterInfos))
                return "imageFilterInfos: array expected";
            for (let i = 0; i < message.imageFilterInfos.length; ++i) {
                let error = $root.ImageFilter.verify(message.imageFilterInfos[i]);
                if (error)
                    return "imageFilterInfos." + error;
            }
        }
        if (message.curImageParam != null && message.hasOwnProperty("curImageParam"))
            if (!$util.isInteger(message.curImageParam))
                return "curImageParam: integer expected";
        if (message.curImageFilter != null && message.hasOwnProperty("curImageFilter"))
            if (!$util.isInteger(message.curImageFilter))
                return "curImageFilter: integer expected";
        if (message.supportVirtualCamera != null && message.hasOwnProperty("supportVirtualCamera"))
            if (typeof message.supportVirtualCamera !== "boolean")
                return "supportVirtualCamera: boolean expected";
        if (message.enableBackGroudBlur != null && message.hasOwnProperty("enableBackGroudBlur"))
            if (typeof message.enableBackGroudBlur !== "boolean")
                return "enableBackGroudBlur: boolean expected";
        if (message.enableBackGroudReplace != null && message.hasOwnProperty("enableBackGroudReplace"))
            if (typeof message.enableBackGroudReplace !== "boolean")
                return "enableBackGroudReplace: boolean expected";
        if (message.supportBlurModeList != null && message.hasOwnProperty("supportBlurModeList")) {
            if (!Array.isArray(message.supportBlurModeList))
                return "supportBlurModeList: array expected";
            for (let i = 0; i < message.supportBlurModeList.length; ++i)
                if (!$util.isInteger(message.supportBlurModeList[i]))
                    return "supportBlurModeList: integer[] expected";
        }
        if (message.replaceIndex != null && message.hasOwnProperty("replaceIndex"))
            if (!$util.isInteger(message.replaceIndex))
                return "replaceIndex: integer expected";
        if (message.antiFlicker != null && message.hasOwnProperty("antiFlicker"))
            if (!$util.isInteger(message.antiFlicker))
                return "antiFlicker: integer expected";
        if (message.audioCaptureMode != null && message.hasOwnProperty("audioCaptureMode"))
            if (!$util.isInteger(message.audioCaptureMode))
                return "audioCaptureMode: integer expected";
        if (message.curBlurMode != null && message.hasOwnProperty("curBlurMode"))
            if (!$util.isInteger(message.curBlurMode))
                return "curBlurMode: integer expected";
        if (message.enableSmartAdjust != null && message.hasOwnProperty("enableSmartAdjust"))
            if (typeof message.enableSmartAdjust !== "boolean")
                return "enableSmartAdjust: boolean expected";
        if (message.enablePrivacyMode != null && message.hasOwnProperty("enablePrivacyMode"))
            if (typeof message.enablePrivacyMode !== "boolean")
                return "enablePrivacyMode: boolean expected";
        if (message.enableRollAdjust != null && message.hasOwnProperty("enableRollAdjust"))
            if (typeof message.enableRollAdjust !== "boolean")
                return "enableRollAdjust: boolean expected";
        if (message.enableLowerRes != null && message.hasOwnProperty("enableLowerRes"))
            if (typeof message.enableLowerRes !== "boolean")
                return "enableLowerRes: boolean expected";
        ...
        if (message.gestureEnabled != null && message.hasOwnProperty("gestureEnabled"))
            if (typeof message.gestureEnabled !== "boolean")
                return "gestureEnabled: boolean expected";
        if (message.gesturePlamEnabled != null && message.hasOwnProperty("gesturePlamEnabled"))
            if (typeof message.gesturePlamEnabled !== "boolean")
                return "gesturePlamEnabled: boolean expected";
        if (message.gestureVEnabled != null && message.hasOwnProperty("gestureVEnabled"))
            if (typeof message.gestureVEnabled !== "boolean")
                return "gestureVEnabled: boolean expected";
        if (message.gestureLEnabled != null && message.hasOwnProperty("gestureLEnabled"))
            if (typeof message.gestureLEnabled !== "boolean")
                return "gestureLEnabled: boolean expected";
        if (message.gestureRockEnabled != null && message.hasOwnProperty("gestureRockEnabled"))
            if (typeof message.gestureRockEnabled !== "boolean")
                return "gestureRockEnabled: boolean expected";
        if (message.gestureOkEnabled != null && message.hasOwnProperty("gestureOkEnabled"))
            if (typeof message.gestureOkEnabled !== "boolean")
                return "gestureOkEnabled: boolean expected";
        if (message.enableAutoFocus != null && message.hasOwnProperty("enableAutoFocus"))
            if (typeof message.enableAutoFocus !== "boolean")
                return "enableAutoFocus: boolean expected";
        if (message.maualFocus != null && message.hasOwnProperty("maualFocus"))
            if (!$util.isInteger(message.maualFocus))
                return "maualFocus: integer expected";
        if (message.enableVerticalScreen != null && message.hasOwnProperty("enableVerticalScreen"))
            if (typeof message.enableVerticalScreen !== "boolean")
                return "enableVerticalScreen: boolean expected";
        if (message.videoPrivacyMode != null && message.hasOwnProperty("videoPrivacyMode"))
            if (typeof message.videoPrivacyMode !== "boolean")
                return "videoPrivacyMode: boolean expected";
        ...
        if (message.funeTuningValue != null && message.hasOwnProperty("funeTuningValue"))
            if (typeof message.funeTuningValue !== "number")
                return "funeTuningValue: number expected";
        if (message.verScreenLock != null && message.hasOwnProperty("verScreenLock"))
            if (typeof message.verScreenLock !== "boolean")
                return "verScreenLock: boolean expected";
        if (message.enableTrackForiddenArea != null && message.hasOwnProperty("enableTrackForiddenArea"))
            if (typeof message.enableTrackForiddenArea !== "boolean")
                return "enableTrackForiddenArea: boolean expected";
        return null;
    };
     ...
     * @returns {DeviceSettingInfo} DeviceSettingInfo
     */
    DeviceSettingInfo.fromObject = function fromObject(object) {
        if (object instanceof $root.DeviceSettingInfo)
            return object;
        let message = new $root.DeviceSettingInfo();
        ...
        if (object.enableAutoTrack != null)
            message.enableAutoTrack = Boolean(object.enableAutoTrack);
        if (object.enableSingleTapTracking != null)
            message.enableSingleTapTracking = Boolean(object.enableSingleTapTracking);
        ...
        if (object.satutation != null)
            message.satutation = object.satutation | 0;
        ...
        if (object.imageParamPresetInfos) {
            if (!Array.isArray(object.imageParamPresetInfos))
                throw TypeError(".DeviceSettingInfo.imageParamPresetInfos: array expected");
            message.imageParamPresetInfos = [];
            for (let i = 0; i < object.imageParamPresetInfos.length; ++i) {
                if (typeof object.imageParamPresetInfos[i] !== "object")
                    throw TypeError(".DeviceSettingInfo.imageParamPresetInfos: object expected");
                message.imageParamPresetInfos[i] = $root.ImageParamPreset.fromObject(object.imageParamPresetInfos[i]);
            }
        }
        if (object.imageFilterInfos) {
            if (!Array.isArray(object.imageFilterInfos))
                throw TypeError(".DeviceSettingInfo.imageFilterInfos: array expected");
            message.imageFilterInfos = [];
            for (let i = 0; i < object.imageFilterInfos.length; ++i) {
                if (typeof object.imageFilterInfos[i] !== "object")
                    throw TypeError(".DeviceSettingInfo.imageFilterInfos: object expected");
                message.imageFilterInfos[i] = $root.ImageFilter.fromObject(object.imageFilterInfos[i]);
            }
        }
        if (object.curImageParam != null)
            message.curImageParam = object.curImageParam | 0;
        if (object.curImageFilter != null)
            message.curImageFilter = object.curImageFilter | 0;
        if (object.supportVirtualCamera != null)
            message.supportVirtualCamera = Boolean(object.supportVirtualCamera);
        if (object.enableBackGroudBlur != null)
            message.enableBackGroudBlur = Boolean(object.enableBackGroudBlur);
        if (object.enableBackGroudReplace != null)
            message.enableBackGroudReplace = Boolean(object.enableBackGroudReplace);
        if (object.supportBlurModeList) {
            if (!Array.isArray(object.supportBlurModeList))
                throw TypeError(".DeviceSettingInfo.supportBlurModeList: array expected");
            message.supportBlurModeList = [];
            for (let i = 0; i < object.supportBlurModeList.length; ++i)
                message.supportBlurModeList[i] = object.supportBlurModeList[i] | 0;
        }
        if (object.replaceIndex != null)
            message.replaceIndex = object.replaceIndex | 0;
        if (object.antiFlicker != null)
            message.antiFlicker = object.antiFlicker | 0;
        if (object.audioCaptureMode != null)
            message.audioCaptureMode = object.audioCaptureMode | 0;
        if (object.curBlurMode != null)
            message.curBlurMode = object.curBlurMode | 0;
        if (object.enableSmartAdjust != null)
            message.enableSmartAdjust = Boolean(object.enableSmartAdjust);
        if (object.enablePrivacyMode != null)
            message.enablePrivacyMode = Boolean(object.enablePrivacyMode);
        if (object.enableRollAdjust != null)
            message.enableRollAdjust = Boolean(object.enableRollAdjust);
        if (object.enableLowerRes != null)
            message.enableLowerRes = Boolean(object.enableLowerRes);
        if (object.blurRadius != null)
            message.blurRadius = object.blurRadius | 0;
        if (object.gestureEnabled != null)
            message.gestureEnabled = Boolean(object.gestureEnabled);
        if (object.gesturePlamEnabled != null)
            message.gesturePlamEnabled = Boolean(object.gesturePlamEnabled);
        if (object.gestureVEnabled != null)
            message.gestureVEnabled = Boolean(object.gestureVEnabled);
        if (object.gestureLEnabled != null)
            message.gestureLEnabled = Boolean(object.gestureLEnabled);
        if (object.gestureRockEnabled != null)
            message.gestureRockEnabled = Boolean(object.gestureRockEnabled);
        if (object.gestureOkEnabled != null)
            message.gestureOkEnabled = Boolean(object.gestureOkEnabled);
        if (object.enableAutoFocus != null)
            message.enableAutoFocus = Boolean(object.enableAutoFocus);
        if (object.maualFocus != null)
            message.maualFocus = object.maualFocus | 0;
        if (object.enableVerticalScreen != null)
            message.enableVerticalScreen = Boolean(object.enableVerticalScreen);
        if (object.videoPrivacyMode != null)
            message.videoPrivacyMode = Boolean(object.videoPrivacyMode);
        if (object.resolution != null)
            message.resolution = String(object.resolution);
        if (object.funeTuningValue != null)
            message.funeTuningValue = Number(object.funeTuningValue);
        if (object.verScreenLock != null)
            message.verScreenLock = Boolean(object.verScreenLock);
        if (object.enableTrackForiddenArea != null)
            message.enableTrackForiddenArea = Boolean(object.enableTrackForiddenArea);
        return message;
    };
     ...
     * @memberof DeviceSettingInfo
     * @static
     * @param {DeviceSettingInfo} message DeviceSettingInfo
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    DeviceSettingInfo.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.arrays || options.defaults) {
            object.imageParamPresetInfos = [];
            object.imageFilterInfos = [];
            object.supportBlurModeList = [];
        }
        if (options.defaults) {
            object.compositionStyle = 0;
            object.trackSpeed = 0;
            object.enableAutoTrack = false;
            object.enableSingleTapTracking = false;
            ...
            object.curImageParam = 0;
            object.curImageFilter = 0;
            object.supportVirtualCamera = false;
            object.enableBackGroudBlur = false;
            object.enableBackGroudReplace = false;
            object.replaceIndex = 0;
            object.antiFlicker = 0;
            object.audioCaptureMode = 0;
            object.curBlurMode = 0;
            object.enableSmartAdjust = false;
            object.enablePrivacyMode = false;
            object.enableRollAdjust = false;
            object.enableLowerRes = false;
            object.blurRadius = 0;
            object.gestureEnabled = false;
            object.gesturePlamEnabled = false;
            object.gestureVEnabled = false;
            object.gestureLEnabled = false;
            object.gestureRockEnabled = false;
            object.gestureOkEnabled = false;
            object.enableAutoFocus = false;
            object.maualFocus = 0;
            object.enableVerticalScreen = false;
            object.videoPrivacyMode = false;
            object.resolution = "";
            object.funeTuningValue = 0;
            object.verScreenLock = false;
            object.enableTrackForiddenArea = false;
        }
        if (message.compositionStyle != null && message.hasOwnProperty("compositionStyle"))
        ...
        if (message.enableAutoTrack != null && message.hasOwnProperty("enableAutoTrack"))
            object.enableAutoTrack = message.enableAutoTrack;
        if (message.enableSingleTapTracking != null && message.hasOwnProperty("enableSingleTapTracking"))
            object.enableSingleTapTracking = message.enableSingleTapTracking;
        if (message.compositionStyleEnabled != null && message.hasOwnProperty("compositionStyleEnabled"))
        ...
        if (message.satutation != null && message.hasOwnProperty("satutation"))
            object.satutation = message.satutation;
        if (message.sharpening != null && message.hasOwnProperty("sharpening"))
        ...
        if (message.imageParamPresetInfos && message.imageParamPresetInfos.length) {
            object.imageParamPresetInfos = [];
            for (let j = 0; j < message.imageParamPresetInfos.length; ++j)
                object.imageParamPresetInfos[j] = $root.ImageParamPreset.toObject(message.imageParamPresetInfos[j], options);
        }
        if (message.imageFilterInfos && message.imageFilterInfos.length) {
            object.imageFilterInfos = [];
            for (let j = 0; j < message.imageFilterInfos.length; ++j)
                object.imageFilterInfos[j] = $root.ImageFilter.toObject(message.imageFilterInfos[j], options);
        }
        if (message.curImageParam != null && message.hasOwnProperty("curImageParam"))
            object.curImageParam = message.curImageParam;
        if (message.curImageFilter != null && message.hasOwnProperty("curImageFilter"))
            object.curImageFilter = message.curImageFilter;
        if (message.supportVirtualCamera != null && message.hasOwnProperty("supportVirtualCamera"))
            object.supportVirtualCamera = message.supportVirtualCamera;
        if (message.enableBackGroudBlur != null && message.hasOwnProperty("enableBackGroudBlur"))
            object.enableBackGroudBlur = message.enableBackGroudBlur;
        if (message.enableBackGroudReplace != null && message.hasOwnProperty("enableBackGroudReplace"))
            object.enableBackGroudReplace = message.enableBackGroudReplace;
        if (message.supportBlurModeList && message.supportBlurModeList.length) {
            object.supportBlurModeList = [];
            for (let j = 0; j < message.supportBlurModeList.length; ++j)
                object.supportBlurModeList[j] = message.supportBlurModeList[j];
        }
        if (message.replaceIndex != null && message.hasOwnProperty("replaceIndex"))
            object.replaceIndex = message.replaceIndex;
        if (message.antiFlicker != null && message.hasOwnProperty("antiFlicker"))
            object.antiFlicker = message.antiFlicker;
        if (message.audioCaptureMode != null && message.hasOwnProperty("audioCaptureMode"))
            object.audioCaptureMode = message.audioCaptureMode;
        if (message.curBlurMode != null && message.hasOwnProperty("curBlurMode"))
            object.curBlurMode = message.curBlurMode;
        if (message.enableSmartAdjust != null && message.hasOwnProperty("enableSmartAdjust"))
            object.enableSmartAdjust = message.enableSmartAdjust;
        if (message.enablePrivacyMode != null && message.hasOwnProperty("enablePrivacyMode"))
            object.enablePrivacyMode = message.enablePrivacyMode;
        if (message.enableRollAdjust != null && message.hasOwnProperty("enableRollAdjust"))
            object.enableRollAdjust = message.enableRollAdjust;
        if (message.enableLowerRes != null && message.hasOwnProperty("enableLowerRes"))
            object.enableLowerRes = message.enableLowerRes;
        if (message.blurRadius != null && message.hasOwnProperty("blurRadius"))
            object.blurRadius = message.blurRadius;
        if (message.gestureEnabled != null && message.hasOwnProperty("gestureEnabled"))
            object.gestureEnabled = message.gestureEnabled;
        if (message.gesturePlamEnabled != null && message.hasOwnProperty("gesturePlamEnabled"))
            object.gesturePlamEnabled = message.gesturePlamEnabled;
        if (message.gestureVEnabled != null && message.hasOwnProperty("gestureVEnabled"))
            object.gestureVEnabled = message.gestureVEnabled;
        if (message.gestureLEnabled != null && message.hasOwnProperty("gestureLEnabled"))
            object.gestureLEnabled = message.gestureLEnabled;
        if (message.gestureRockEnabled != null && message.hasOwnProperty("gestureRockEnabled"))
            object.gestureRockEnabled = message.gestureRockEnabled;
        if (message.gestureOkEnabled != null && message.hasOwnProperty("gestureOkEnabled"))
            object.gestureOkEnabled = message.gestureOkEnabled;
        if (message.enableAutoFocus != null && message.hasOwnProperty("enableAutoFocus"))
            object.enableAutoFocus = message.enableAutoFocus;
        if (message.maualFocus != null && message.hasOwnProperty("maualFocus"))
            object.maualFocus = message.maualFocus;
        if (message.enableVerticalScreen != null && message.hasOwnProperty("enableVerticalScreen"))
            object.enableVerticalScreen = message.enableVerticalScreen;
        if (message.videoPrivacyMode != null && message.hasOwnProperty("videoPrivacyMode"))
            object.videoPrivacyMode = message.videoPrivacyMode;
        if (message.resolution != null && message.hasOwnProperty("resolution"))
            object.resolution = message.resolution;
        if (message.funeTuningValue != null && message.hasOwnProperty("funeTuningValue"))
            object.funeTuningValue = options.json && !isFinite(message.funeTuningValue) ? String(message.funeTuningValue) : message.funeTuningValue;
        if (message.verScreenLock != null && message.hasOwnProperty("verScreenLock"))
            object.verScreenLock = message.verScreenLock;
        if (message.enableTrackForiddenArea != null && message.hasOwnProperty("enableTrackForiddenArea"))
            object.enableTrackForiddenArea = message.enableTrackForiddenArea;
        return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    DeviceSettingInfo.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    DeviceSettingInfo.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/DeviceSettingInfo";
    };

    return DeviceSettingInfo;
})();

export const ImageParamPreset = $root.ImageParamPreset = (() => {

    /**
     * Properties of an ImageParamPreset.
     * @exports IImageParamPreset
     * @interface IImageParamPreset
     * @property {string|null} [name] ImageParamPreset name
     * @property {number|null} [index] ImageParamPreset index
     */

    /**
     * Constructs a new ImageParamPreset.
     * @exports ImageParamPreset
     * @classdesc Represents an ImageParamPreset.
     * @implements IImageParamPreset
     * @constructor
     * @param {IImageParamPreset=} [properties] Properties to set
     */
    function ImageParamPreset(properties) {
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @member {string} name
     * @memberof ImageParamPreset
     * @instance
     */
    ImageParamPreset.prototype.name = "";
     ...
     * @instance
     */
    ImageParamPreset.prototype.index = 0;
     ...
     * @static
     * @param {IImageParamPreset=} [properties] Properties to set
     * @returns {ImageParamPreset} ImageParamPreset instance
     */
    ImageParamPreset.create = function create(properties) {
        return new ImageParamPreset(properties);
    };
     ...
     * @memberof ImageParamPreset
     * @static
     * @param {IImageParamPreset} message ImageParamPreset message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ImageParamPreset.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.name != null && Object.hasOwnProperty.call(message, "name"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message.name);
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ImageParamPreset.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ImageParamPreset} ImageParamPreset
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageParamPreset.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ImageParamPreset();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageParamPreset.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ImageParamPreset.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.name != null && message.hasOwnProperty("name"))
            if (!$util.isString(message.name))
     ...
     * @returns {ImageParamPreset} ImageParamPreset
     */
    ImageParamPreset.fromObject = function fromObject(object) {
        if (object instanceof $root.ImageParamPreset)
            return object;
        let message = new $root.ImageParamPreset();
        if (object.name != null)
            message.name = String(object.name);
        if (object.index != null)
            message.index = object.index | 0;
     ...
     * @memberof ImageParamPreset
     * @static
     * @param {ImageParamPreset} message ImageParamPreset
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ImageParamPreset.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.defaults) {
     ...
     * @returns {Object.<string,*>} JSON object
     */
    ImageParamPreset.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    ImageParamPreset.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/ImageParamPreset";
    };

    return ImageParamPreset;
})();

export const ImageFilter = $root.ImageFilter = (() => {

    /**
     * Properties of an ImageFilter.
     * @exports IImageFilter
     * @interface IImageFilter
     * @property {string|null} [name] ImageFilter name
     * @property {number|null} [index] ImageFilter index
     */

    /**
     * Constructs a new ImageFilter.
     * @exports ImageFilter
     * @classdesc Represents an ImageFilter.
     * @implements IImageFilter
     * @constructor
     * @param {IImageFilter=} [properties] Properties to set
     */
    function ImageFilter(properties) {
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * ImageFilter name.
     * @member {string} name
     * @memberof ImageFilter
     * @instance
     */
    ImageFilter.prototype.name = "";
     ...
     * @static
     * @param {IImageFilter=} [properties] Properties to set
     * @returns {ImageFilter} ImageFilter instance
     */
    ImageFilter.create = function create(properties) {
        return new ImageFilter(properties);
    };
     ...
     * @memberof ImageFilter
     * @static
     * @param {IImageFilter} message ImageFilter message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ImageFilter.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.name != null && Object.hasOwnProperty.call(message, "name"))
            writer.uint32(/* id 1, wireType 2 =*/10).string(message.name);
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ImageFilter.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ImageFilter} ImageFilter
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageFilter.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ImageFilter();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageFilter.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ImageFilter.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.name != null && message.hasOwnProperty("name"))
            if (!$util.isString(message.name))
     ...
     * @returns {ImageFilter} ImageFilter
     */
    ImageFilter.fromObject = function fromObject(object) {
        if (object instanceof $root.ImageFilter)
            return object;
        let message = new $root.ImageFilter();
        if (object.name != null)
            message.name = String(object.name);
        if (object.index != null)
            message.index = object.index | 0;
     ...
     * @memberof ImageFilter
     * @static
     * @param {ImageFilter} message ImageFilter
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ImageFilter.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.defaults) {
     ...
     * @returns {Object.<string,*>} JSON object
     */
    ImageFilter.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    ImageFilter.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/ImageFilter";
    };

    return ImageFilter;
})();

export const PTZParam = $root.PTZParam = (() => {

    /**
     * Properties of a PTZParam.
     * @exports IPTZParam
     * @interface IPTZParam
     * @property {number|null} [panSpeed] PTZParam panSpeed
     * @property {number|null} [tiltSpeed] PTZParam tiltSpeed
     * @property {number|null} [panValue] PTZParam panValue
     * @property {number|null} [tiltVaule] PTZParam tiltVaule
     * @property {number|null} [hostPTZx] PTZParam hostPTZx
     * @property {number|null} [hostPTZy] PTZParam hostPTZy
     */

    /**
     * Constructs a new PTZParam.
     * @exports PTZParam
     * @classdesc Represents a PTZParam.
     * @implements IPTZParam
     * @constructor
     * @param {IPTZParam=} [properties] Properties to set
     */
    function PTZParam(properties) {
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
    ...
    /**
     * PTZParam panSpeed.
     * @member {number} panSpeed
     * @memberof PTZParam
     * @instance
     */
    PTZParam.prototype.panSpeed = 0;

    /**
     * PTZParam tiltSpeed.
     * @member {number} tiltSpeed
     * @memberof PTZParam
     * @instance
     */
    PTZParam.prototype.tiltSpeed = 0;

    /**
     * PTZParam panValue.
     * @member {number} panValue
     * @memberof PTZParam
     * @instance
     */
    PTZParam.prototype.panValue = 0;

    /**
     * PTZParam tiltVaule.
     * @member {number} tiltVaule
     * @memberof PTZParam
     * @instance
     */
    PTZParam.prototype.tiltVaule = 0;
     ...
     * @static
     * @param {IPTZParam=} [properties] Properties to set
     * @returns {PTZParam} PTZParam instance
     */
    PTZParam.create = function create(properties) {
        return new PTZParam(properties);
    };
     ...
     * @memberof PTZParam
     * @static
     * @param {IPTZParam} message PTZParam message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    PTZParam.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.panSpeed != null && Object.hasOwnProperty.call(message, "panSpeed"))
            writer.uint32(/* id 1, wireType 5 =*/13).float(message.panSpeed);
        if (message.tiltSpeed != null && Object.hasOwnProperty.call(message, "tiltSpeed"))
            writer.uint32(/* id 2, wireType 5 =*/21).float(message.tiltSpeed);
        if (message.panValue != null && Object.hasOwnProperty.call(message, "panValue"))
            writer.uint32(/* id 3, wireType 5 =*/29).float(message.panValue);
        if (message.tiltVaule != null && Object.hasOwnProperty.call(message, "tiltVaule"))
            writer.uint32(/* id 4, wireType 5 =*/37).float(message.tiltVaule);
        if (message.hostPTZx != null && Object.hasOwnProperty.call(message, "hostPTZx"))
            writer.uint32(/* id 5, wireType 1 =*/41).double(message.hostPTZx);
        if (message.hostPTZy != null && Object.hasOwnProperty.call(message, "hostPTZy"))
            writer.uint32(/* id 6, wireType 1 =*/49).double(message.hostPTZy);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    PTZParam.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {PTZParam} PTZParam
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    PTZParam.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.PTZParam();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
                    message.panSpeed = reader.float();
                    break;
                }
            case 2: {
                    message.tiltSpeed = reader.float();
                    break;
                }
            case 3: {
                    message.panValue = reader.float();
                    break;
                }
            case 4: {
                    message.tiltVaule = reader.float();
                    break;
                }
            case 5: {
                    message.hostPTZx = reader.double();
                    break;
                }
            case 6: {
                    message.hostPTZy = reader.double();
                    break;
                }
            default:
                reader.skipType(tag & 7);
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    PTZParam.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    PTZParam.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.panSpeed != null && message.hasOwnProperty("panSpeed"))
            if (typeof message.panSpeed !== "number")
                return "panSpeed: number expected";
        if (message.tiltSpeed != null && message.hasOwnProperty("tiltSpeed"))
            if (typeof message.tiltSpeed !== "number")
                return "tiltSpeed: number expected";
        if (message.panValue != null && message.hasOwnProperty("panValue"))
            if (typeof message.panValue !== "number")
                return "panValue: number expected";
        if (message.tiltVaule != null && message.hasOwnProperty("tiltVaule"))
            if (typeof message.tiltVaule !== "number")
                return "tiltVaule: number expected";
        if (message.hostPTZx != null && message.hasOwnProperty("hostPTZx"))
            if (typeof message.hostPTZx !== "number")
                return "hostPTZx: number expected";
        if (message.hostPTZy != null && message.hasOwnProperty("hostPTZy"))
     ...
     * @returns {PTZParam} PTZParam
     */
    PTZParam.fromObject = function fromObject(object) {
        if (object instanceof $root.PTZParam)
            return object;
        let message = new $root.PTZParam();
        if (object.panSpeed != null)
            message.panSpeed = Number(object.panSpeed);
        if (object.tiltSpeed != null)
            message.tiltSpeed = Number(object.tiltSpeed);
        if (object.panValue != null)
            message.panValue = Number(object.panValue);
        if (object.tiltVaule != null)
            message.tiltVaule = Number(object.tiltVaule);
        if (object.hostPTZx != null)
            message.hostPTZx = Number(object.hostPTZx);
        if (object.hostPTZy != null)
            message.hostPTZy = Number(object.hostPTZy);
     ...
     * @memberof PTZParam
     * @static
     * @param {PTZParam} message PTZParam
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    PTZParam.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.defaults) {
        ...
        if (message.panSpeed != null && message.hasOwnProperty("panSpeed"))
            object.panSpeed = options.json && !isFinite(message.panSpeed) ? String(message.panSpeed) : message.panSpeed;
        if (message.tiltSpeed != null && message.hasOwnProperty("tiltSpeed"))
            object.tiltSpeed = options.json && !isFinite(message.tiltSpeed) ? String(message.tiltSpeed) : message.tiltSpeed;
        if (message.panValue != null && message.hasOwnProperty("panValue"))
            object.panValue = options.json && !isFinite(message.panValue) ? String(message.panValue) : message.panValue;
        if (message.tiltVaule != null && message.hasOwnProperty("tiltVaule"))
            object.tiltVaule = options.json && !isFinite(message.tiltVaule) ? String(message.tiltVaule) : message.tiltVaule;
        if (message.hostPTZx != null && message.hasOwnProperty("hostPTZx"))
            object.hostPTZx = options.json && !isFinite(message.hostPTZx) ? String(message.hostPTZx) : message.hostPTZx;
        if (message.hostPTZy != null && message.hasOwnProperty("hostPTZy"))
            object.hostPTZy = options.json && !isFinite(message.hostPTZy) ? String(message.hostPTZy) : message.hostPTZy;
     ...
     * @returns {Object.<string,*>} JSON object
     */
    PTZParam.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    PTZParam.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/PTZParam";
    };
...
export const ValueChangeNotification = $root.ValueChangeNotification = (() => {
     ...
     * @property {IPTZParam|null} [ptzParam] ValueChangeNotification ptzParam
     */
     ...
     * @member {IPTZParam|null|undefined} ptzParam
     * @memberof ValueChangeNotification
     * @instance
     */
    ValueChangeNotification.prototype.ptzParam = null;
    ...
    ValueChangeNotification.encode = function encode(message, writer) {
        ...
        if (message.ptzParam != null && Object.hasOwnProperty.call(message, "ptzParam"))
            $root.PTZParam.encode(message.ptzParam, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
        return writer;
    };
    ...
    ValueChangeNotification.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
            ...
            case 4: {
                    message.ptzParam = $root.PTZParam.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    ValueChangeNotification.verify = function verify(message) {
        ...
        if (message.ptzParam != null && message.hasOwnProperty("ptzParam")) {
            let error = $root.PTZParam.verify(message.ptzParam);
            if (error)
                return "ptzParam." + error;
        }
        return null;
    };
    ...
    ValueChangeNotification.fromObject = function fromObject(object) {
        ...
        if (object.ptzParam != null) {
            if (typeof object.ptzParam !== "object")
                throw TypeError(".ValueChangeNotification.ptzParam: object expected");
            message.ptzParam = $root.PTZParam.fromObject(object.ptzParam);
        }
        return message;
    };
    ...
    ValueChangeNotification.toObject = function toObject(message, options) {
        ...
        if (message.ptzParam != null && message.hasOwnProperty("ptzParam"))
            object.ptzParam = $root.PTZParam.toObject(message.ptzParam, options);
        return object;
    };
...
export const PresetUpdateResponse = $root.PresetUpdateResponse = (() => {
     ...
     * @property {IDeviceBasicInfo|null} [curDeviceInfo] PresetUpdateResponse curDeviceInfo
     */
     ...
     * @member {IDeviceBasicInfo|null|undefined} curDeviceInfo
     * @memberof PresetUpdateResponse
     * @instance
     */
    ...
    PresetUpdateResponse.encode = function encode(message, writer) {
        ...
        if (message.curDeviceInfo != null && Object.hasOwnProperty.call(message, "curDeviceInfo"))
            $root.DeviceBasicInfo.encode(message.curDeviceInfo, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        return writer;
    };
    ...
    PresetUpdateResponse.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
            ...
            case 3: {
                    message.curDeviceInfo = $root.DeviceBasicInfo.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    PresetUpdateResponse.verify = function verify(message) {
        ...
        if (message.curDeviceInfo != null && message.hasOwnProperty("curDeviceInfo")) {
            let error = $root.DeviceBasicInfo.verify(message.curDeviceInfo);
            if (error)
    ...
    PresetUpdateResponse.fromObject = function fromObject(object) {
        ...
        if (object.curDeviceInfo != null) {
            ...
            message.curDeviceInfo = $root.DeviceBasicInfo.fromObject(object.curDeviceInfo);
        }
        return message;
    };
    ...
    PresetUpdateResponse.toObject = function toObject(message, options) {
        ...
        if (message.curDeviceInfo != null && message.hasOwnProperty("curDeviceInfo"))
            object.curDeviceInfo = $root.DeviceBasicInfo.toObject(message.curDeviceInfo, options);
        return object;
    };
...
export const ImageParamPresetUpdateRequest = $root.ImageParamPresetUpdateRequest = (() => {

    /**
     * Properties of an ImageParamPresetUpdateRequest.
     * @exports IImageParamPresetUpdateRequest
     * @interface IImageParamPresetUpdateRequest
     * @property {Array.<IImageParamPreset>|null} [imageParamPresetInfos] ImageParamPresetUpdateRequest imageParamPresetInfos
     * @property {number|null} [curImageParam] ImageParamPresetUpdateRequest curImageParam
     * @property {string|null} [curDeviceSerialNum] ImageParamPresetUpdateRequest curDeviceSerialNum
     */

    /**
     * Constructs a new ImageParamPresetUpdateRequest.
     * @exports ImageParamPresetUpdateRequest
     * @classdesc Represents an ImageParamPresetUpdateRequest.
     * @implements IImageParamPresetUpdateRequest
     * @constructor
     * @param {IImageParamPresetUpdateRequest=} [properties] Properties to set
     */
    function ImageParamPresetUpdateRequest(properties) {
        this.imageParamPresetInfos = [];
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
     ...
     * @member {Array.<IImageParamPreset>} imageParamPresetInfos
     * @memberof ImageParamPresetUpdateRequest
     * @instance
     */
    ImageParamPresetUpdateRequest.prototype.imageParamPresetInfos = $util.emptyArray;
     ...
     * @instance
     */
    ImageParamPresetUpdateRequest.prototype.curImageParam = 0;
     ...
     * @instance
     */
    ImageParamPresetUpdateRequest.prototype.curDeviceSerialNum = "";
     ...
     * @static
     * @param {IImageParamPresetUpdateRequest=} [properties] Properties to set
     * @returns {ImageParamPresetUpdateRequest} ImageParamPresetUpdateRequest instance
     */
    ImageParamPresetUpdateRequest.create = function create(properties) {
        return new ImageParamPresetUpdateRequest(properties);
    };
     ...
     * @memberof ImageParamPresetUpdateRequest
     * @static
     * @param {IImageParamPresetUpdateRequest} message ImageParamPresetUpdateRequest message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ImageParamPresetUpdateRequest.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.imageParamPresetInfos != null && message.imageParamPresetInfos.length)
            for (let i = 0; i < message.imageParamPresetInfos.length; ++i)
                $root.ImageParamPreset.encode(message.imageParamPresetInfos[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
        if (message.curImageParam != null && Object.hasOwnProperty.call(message, "curImageParam"))
            writer.uint32(/* id 2, wireType 0 =*/16).int32(message.curImageParam);
        if (message.curDeviceSerialNum != null && Object.hasOwnProperty.call(message, "curDeviceSerialNum"))
            writer.uint32(/* id 3, wireType 2 =*/26).string(message.curDeviceSerialNum);
        return writer;
    };
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ImageParamPresetUpdateRequest.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ImageParamPresetUpdateRequest} ImageParamPresetUpdateRequest
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageParamPresetUpdateRequest.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ImageParamPresetUpdateRequest();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageParamPresetUpdateRequest.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ImageParamPresetUpdateRequest.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.imageParamPresetInfos != null && message.hasOwnProperty("imageParamPresetInfos")) {
            if (!Array.isArray(message.imageParamPresetInfos))
     ...
     * @returns {ImageParamPresetUpdateRequest} ImageParamPresetUpdateRequest
     */
    ImageParamPresetUpdateRequest.fromObject = function fromObject(object) {
        if (object instanceof $root.ImageParamPresetUpdateRequest)
            return object;
        let message = new $root.ImageParamPresetUpdateRequest();
        if (object.imageParamPresetInfos) {
            if (!Array.isArray(object.imageParamPresetInfos))
                throw TypeError(".ImageParamPresetUpdateRequest.imageParamPresetInfos: array expected");
            message.imageParamPresetInfos = [];
            for (let i = 0; i < object.imageParamPresetInfos.length; ++i) {
                if (typeof object.imageParamPresetInfos[i] !== "object")
                    throw TypeError(".ImageParamPresetUpdateRequest.imageParamPresetInfos: object expected");
                message.imageParamPresetInfos[i] = $root.ImageParamPreset.fromObject(object.imageParamPresetInfos[i]);
            }
        }
        if (object.curImageParam != null)
     ...
     * @memberof ImageParamPresetUpdateRequest
     * @static
     * @param {ImageParamPresetUpdateRequest} message ImageParamPresetUpdateRequest
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ImageParamPresetUpdateRequest.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.arrays || options.defaults)
     ...
     * @returns {Object.<string,*>} JSON object
     */
    ImageParamPresetUpdateRequest.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    ImageParamPresetUpdateRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/ImageParamPresetUpdateRequest";
    };

    return ImageParamPresetUpdateRequest;
})();

export const ImageParamPresetUpdateResponse = $root.ImageParamPresetUpdateResponse = (() => {

    /**
     * Properties of an ImageParamPresetUpdateResponse.
     * @exports IImageParamPresetUpdateResponse
     * @interface IImageParamPresetUpdateResponse
     * @property {boolean|null} [success] ImageParamPresetUpdateResponse success
     * @property {ImageParamPresetUpdateResponse.FailureReason|null} [reason] ImageParamPresetUpdateResponse reason
     * @property {IDeviceBasicInfo|null} [curDeviceInfo] ImageParamPresetUpdateResponse curDeviceInfo
     */

    /**
     * Constructs a new ImageParamPresetUpdateResponse.
     * @exports ImageParamPresetUpdateResponse
     * @classdesc Represents an ImageParamPresetUpdateResponse.
     * @implements IImageParamPresetUpdateResponse
     * @constructor
     * @param {IImageParamPresetUpdateResponse=} [properties] Properties to set
     */
    function ImageParamPresetUpdateResponse(properties) {
        if (properties)
            for (let keys = Object.keys(properties), i = 0; i < keys.length; ++i)
                if (properties[keys[i]] != null)
                    this[keys[i]] = properties[keys[i]];
     ...
     * @member {boolean} success
     * @memberof ImageParamPresetUpdateResponse
     * @instance
     */
    ImageParamPresetUpdateResponse.prototype.success = false;

    /**
     * ImageParamPresetUpdateResponse reason.
     * @member {ImageParamPresetUpdateResponse.FailureReason} reason
     * @memberof ImageParamPresetUpdateResponse
     * @instance
     */
    ImageParamPresetUpdateResponse.prototype.reason = 0;
     ...
     * @instance
     */
    ImageParamPresetUpdateResponse.prototype.curDeviceInfo = null;
     ...
     * @static
     * @param {IImageParamPresetUpdateResponse=} [properties] Properties to set
     * @returns {ImageParamPresetUpdateResponse} ImageParamPresetUpdateResponse instance
     */
    ImageParamPresetUpdateResponse.create = function create(properties) {
        return new ImageParamPresetUpdateResponse(properties);
    };
     ...
     * @memberof ImageParamPresetUpdateResponse
     * @static
     * @param {IImageParamPresetUpdateResponse} message ImageParamPresetUpdateResponse message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    ImageParamPresetUpdateResponse.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
        if (message.success != null && Object.hasOwnProperty.call(message, "success"))
            writer.uint32(/* id 1, wireType 0 =*/8).bool(message.success);
     ...
     * @returns {$protobuf.Writer} Writer
     */
    ImageParamPresetUpdateResponse.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {ImageParamPresetUpdateResponse} ImageParamPresetUpdateResponse
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageParamPresetUpdateResponse.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        let end = length === undefined ? reader.len : reader.pos + length, message = new $root.ImageParamPresetUpdateResponse();
        while (reader.pos < end) {
            let tag = reader.uint32();
            switch (tag >>> 3) {
            case 1: {
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    ImageParamPresetUpdateResponse.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    ImageParamPresetUpdateResponse.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
        if (message.success != null && message.hasOwnProperty("success"))
            if (typeof message.success !== "boolean")
     ...
     * @returns {ImageParamPresetUpdateResponse} ImageParamPresetUpdateResponse
     */
    ImageParamPresetUpdateResponse.fromObject = function fromObject(object) {
        if (object instanceof $root.ImageParamPresetUpdateResponse)
            return object;
        let message = new $root.ImageParamPresetUpdateResponse();
        if (object.success != null)
            message.success = Boolean(object.success);
        switch (object.reason) {
        default:
        ...
        if (object.curDeviceInfo != null) {
            if (typeof object.curDeviceInfo !== "object")
                throw TypeError(".ImageParamPresetUpdateResponse.curDeviceInfo: object expected");
            message.curDeviceInfo = $root.DeviceBasicInfo.fromObject(object.curDeviceInfo);
        }
        return message;
    };
     ...
     * @memberof ImageParamPresetUpdateResponse
     * @static
     * @param {ImageParamPresetUpdateResponse} message ImageParamPresetUpdateResponse
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    ImageParamPresetUpdateResponse.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        let object = {};
        if (options.defaults) {
        ...
        if (message.success != null && message.hasOwnProperty("success"))
            object.success = message.success;
        if (message.reason != null && message.hasOwnProperty("reason"))
            object.reason = options.enums === String ? $root.ImageParamPresetUpdateResponse.FailureReason[message.reason] === undefined ? message.reason : $root.ImageParamPresetUpdateResponse.FailureReason[message.reason] : message.reason;
        if (message.curDeviceInfo != null && message.hasOwnProperty("curDeviceInfo"))
            object.curDeviceInfo = $root.DeviceBasicInfo.toObject(message.curDeviceInfo, options);
        return object;
    };
     ...
     * @returns {Object.<string,*>} JSON object
     */
    ImageParamPresetUpdateResponse.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
     ...
     * @returns {string} The default type url
     */
    ImageParamPresetUpdateResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
        if (typeUrlPrefix === undefined) {
            typeUrlPrefix = "type.googleapis.com";
        }
        return typeUrlPrefix + "/ImageParamPresetUpdateResponse";
    };

    /**
     * FailureReason enum.
     * @name ImageParamPresetUpdateResponse.FailureReason
     * @enum {number}
     * @property {number} UNKNOW_FAILURE=0 UNKNOW_FAILURE value
     * @property {number} LINK_DISCONNECTED=1 LINK_DISCONNECTED value
     */
    ImageParamPresetUpdateResponse.FailureReason = (function() {
        const valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "UNKNOW_FAILURE"] = 0;
        values[valuesById[1] = "LINK_DISCONNECTED"] = 1;
        return values;
    ...
    return ImageParamPresetUpdateResponse;
})();
...
export const Response = $root.Response = (() => {
     ...
     * @property {boolean|null} [hasImageParamPresetUpdateRequest] Response hasImageParamPresetUpdateRequest
     ...
     * @property {IImageParamPresetUpdateRequest|null} [imageParamRequest] Response imageParamRequest
     */
     ...
     * @member {boolean} hasImageParamPresetUpdateRequest
     * @memberof Response
     * @instance
     */
    Response.prototype.hasImageParamPresetUpdateRequest = false;
     ...
     * @member {IImageParamPresetUpdateRequest|null|undefined} imageParamRequest
     * @memberof Response
     * @instance
     */
    Response.prototype.imageParamRequest = null;
    ...
    Response.encode = function encode(message, writer) {
        ...
        if (message.hasImageParamPresetUpdateRequest != null && Object.hasOwnProperty.call(message, "hasImageParamPresetUpdateRequest"))
            writer.uint32(/* id 8, wireType 0 =*/64).bool(message.hasImageParamPresetUpdateRequest);
        ...
        if (message.imageParamRequest != null && Object.hasOwnProperty.call(message, "imageParamRequest"))
            $root.ImageParamPresetUpdateRequest.encode(message.imageParamRequest, writer.uint32(/* id 17, wireType 2 =*/138).fork()).ldelim();
        return writer;
    };
    ...
    Response.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
            ...
            case 8: {
                    message.hasImageParamPresetUpdateRequest = reader.bool();
                    break;
                }
            case 10: {
            ...
            case 17: {
                    message.imageParamRequest = $root.ImageParamPresetUpdateRequest.decode(reader, reader.uint32());
                    break;
                }
            default:
                reader.skipType(tag & 7);
    ...
    Response.verify = function verify(message) {
        ...
        if (message.hasImageParamPresetUpdateRequest != null && message.hasOwnProperty("hasImageParamPresetUpdateRequest"))
            if (typeof message.hasImageParamPresetUpdateRequest !== "boolean")
                return "hasImageParamPresetUpdateRequest: boolean expected";
        ...
        if (message.imageParamRequest != null && message.hasOwnProperty("imageParamRequest")) {
            let error = $root.ImageParamPresetUpdateRequest.verify(message.imageParamRequest);
            if (error)
                return "imageParamRequest." + error;
        }
        return null;
    };
    ...
    Response.fromObject = function fromObject(object) {
        ...
        if (object.hasImageParamPresetUpdateRequest != null)
            message.hasImageParamPresetUpdateRequest = Boolean(object.hasImageParamPresetUpdateRequest);
        ...
        if (object.imageParamRequest != null) {
            if (typeof object.imageParamRequest !== "object")
                throw TypeError(".Response.imageParamRequest: object expected");
            message.imageParamRequest = $root.ImageParamPresetUpdateRequest.fromObject(object.imageParamRequest);
        }
        return message;
    };
    ...
    Response.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
            ...
            object.hasImageParamPresetUpdateRequest = false;
        ...
        if (message.hasImageParamPresetUpdateRequest != null && message.hasOwnProperty("hasImageParamPresetUpdateRequest"))
            object.hasImageParamPresetUpdateRequest = message.hasImageParamPresetUpdateRequest;
        if (message.deviceInfoNotify != null && message.hasOwnProperty("deviceInfoNotify"))
        ...
        if (message.imageParamRequest != null && message.hasOwnProperty("imageParamRequest"))
            object.imageParamRequest = $root.ImageParamPresetUpdateRequest.toObject(message.imageParamRequest, options);
        return object;
    };
